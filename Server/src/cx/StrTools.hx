...
class StrTools 
{
	...
	static public function leadingChars(str:String, toLength:Int = 8, leadingChar:String = '0'):String
	{
	...
	static public function intWithLeadingChars(num:Int, toLength:Int = 8, leadingChar:String = '0'):String
	{
		return leadingChars(Std.string(num), toLength, leadingChar);
	}
