...
class HXCPP_CLASS_ATTRIBUTES  Style_obj : public hx::Object{
	...
	public:
		...
		::flash::geom::Rectangle _backgroundImageScale9;
		::flash::geom::Rectangle _backgroundImageRect;
		...
		::flash::filters::BitmapFilter _filter;
		bool _filterSet;
		Float _alpha;
		::String _fontName;
		Float _fontSize;
		...
		virtual ::flash::geom::Rectangle get_backgroundImageScale9( );
		Dynamic get_backgroundImageScale9_dyn();

		virtual ::flash::geom::Rectangle set_backgroundImageScale9( ::flash::geom::Rectangle value);
		Dynamic set_backgroundImageScale9_dyn();

		virtual ::flash::geom::Rectangle get_backgroundImageRect( );
		Dynamic get_backgroundImageRect_dyn();

		virtual ::flash::geom::Rectangle set_backgroundImageRect( ::flash::geom::Rectangle value);
		...
		virtual ::flash::filters::BitmapFilter get_filter( );
		Dynamic get_filter_dyn();

		virtual ::flash::filters::BitmapFilter set_filter( ::flash::filters::BitmapFilter value);
