...
class HXCPP_CLASS_ATTRIBUTES  TextInput_obj : public ::haxe::ui::toolkit::core::StateComponent_obj{
	...
	public:
		...
		virtual Void _onTextChange( ::flash::events::Event event);
		Dynamic _onTextChange_dyn();

		virtual Void _onTextScroll( ::flash::events::Event event);
		...
		::flash::text::TextFormat selectedTextFormat;
		...
		virtual ::flash::text::TextFormat get_selectedTextFormat( );
