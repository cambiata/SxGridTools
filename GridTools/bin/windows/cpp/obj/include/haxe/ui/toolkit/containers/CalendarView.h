...
class HXCPP_CLASS_ATTRIBUTES  CalendarView_obj : public ::haxe::ui::toolkit::containers::VBox_obj{
	...
	public:
		...
		virtual Void _onPrevClicked( ::flash::events::MouseEvent event);
		Dynamic _onPrevClicked_dyn();

		virtual Void _onNextClicked( ::flash::events::MouseEvent event);
		Dynamic _onNextClicked_dyn();

		virtual Void _onDateChanged( ::flash::events::Event event);
