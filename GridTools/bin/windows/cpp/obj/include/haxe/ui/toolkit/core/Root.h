...
class HXCPP_CLASS_ATTRIBUTES  Root_obj : public ::haxe::ui::toolkit::core::Component_obj{
	...
	public:
		...
		::flash::geom::Point _mousePos;
		virtual Void preInitialize( );

		virtual Void _onScreenResize( ::flash::events::Event event);
		Dynamic _onScreenResize_dyn();

		::flash::geom::Point mousePosition;
		virtual ::flash::geom::Point get_mousePosition( );
