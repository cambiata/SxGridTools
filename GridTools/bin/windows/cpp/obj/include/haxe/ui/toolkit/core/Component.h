...
class HXCPP_CLASS_ATTRIBUTES  Component_obj : public ::haxe::ui::toolkit::core::StyleableDisplayObject_obj{
	...
	public:
		...
		::flash::geom::Point mouseDownPos;
		virtual Void _onComponentMouseDown( ::flash::events::MouseEvent event);
		Dynamic _onComponentMouseDown_dyn();

		virtual Void _onComponentMouseUp( ::flash::events::MouseEvent event);
		Dynamic _onComponentMouseUp_dyn();

		virtual Void _onComponentMouseMove( ::flash::events::MouseEvent event);
