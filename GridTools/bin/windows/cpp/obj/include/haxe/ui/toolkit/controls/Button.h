...
class HXCPP_CLASS_ATTRIBUTES  Button_obj : public ::haxe::ui::toolkit::core::StateComponent_obj{
	...
	public:
		...
		virtual Void _onMouseOver( ::flash::events::MouseEvent event);
		Dynamic _onMouseOver_dyn();

		virtual Void _onMouseOut( ::flash::events::MouseEvent event);
		Dynamic _onMouseOut_dyn();

		virtual Void _onMouseDown( ::flash::events::MouseEvent event);
		Dynamic _onMouseDown_dyn();

		virtual Void _onMouseUp( ::flash::events::MouseEvent event);
		Dynamic _onMouseUp_dyn();

		virtual Void _onMouseClick( ::flash::events::MouseEvent event);
