...
class HXCPP_CLASS_ATTRIBUTES  ScrollView_obj : public ::haxe::ui::toolkit::core::StateComponent_obj{
	...
	public:
		...
		bool _showHScroll;
		bool _showVScroll;
		::flash::display::Sprite _eventTarget;
		::flash::geom::Point _downPos;
		...
		virtual Void _onHScrollChange( ::flash::events::Event event);
		Dynamic _onHScrollChange_dyn();

		virtual Void _onVScrollChange( ::flash::events::Event event);
		Dynamic _onVScrollChange_dyn();

		virtual Void _onMouseWheel( ::flash::events::MouseEvent event);
