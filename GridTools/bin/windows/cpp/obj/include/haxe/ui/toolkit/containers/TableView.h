...
class HXCPP_CLASS_ATTRIBUTES  TableView_obj : public ::haxe::ui::toolkit::core::Component_obj{
	...
	public:
		...
		virtual Void _onDataSourceChanged( ::flash::events::Event event);
		...
		virtual Void handleListSelection( ::haxe::ui::toolkit::containers::TableViewRow item,::flash::events::Event event,hx::Null< bool >  raiseEvent);
		Dynamic handleListSelection_dyn();

		virtual Void handleClick( ::haxe::ui::toolkit::containers::TableViewRow item,::flash::events::MouseEvent event);
