...
class HXCPP_CLASS_ATTRIBUTES  HScroll_obj : public ::haxe::ui::toolkit::controls::Scroll_obj{
	...
	public:
		...
		::flash::utils::Timer _scrollTimer;
		bool _hasButtons;
		virtual Void preInitialize( );

		virtual Void initialize( );

		virtual Void _onThumbMouseDown( ::flash::events::MouseEvent event);
		Dynamic _onThumbMouseDown_dyn();

		virtual Void _onScreenMouseMove( ::flash::events::MouseEvent event);
		Dynamic _onScreenMouseMove_dyn();

		virtual Void _onScreenMouseUp( ::flash::events::MouseEvent event);
		Dynamic _onScreenMouseUp_dyn();

		virtual Void _onDeinc( ::flash::events::MouseEvent event);
		Dynamic _onDeinc_dyn();

		virtual Void _onInc( ::flash::events::MouseEvent event);
		Dynamic _onInc_dyn();

		virtual Void _onScrollTimerComplete( ::flash::events::TimerEvent event);
		Dynamic _onScrollTimerComplete_dyn();

		virtual Void _onMouseDown( ::flash::events::MouseEvent event);
