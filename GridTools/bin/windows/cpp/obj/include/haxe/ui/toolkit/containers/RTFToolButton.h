...
#define INCLUDED_haxe_ui_toolkit_containers_RTFToolButton
...
class HXCPP_CLASS_ATTRIBUTES  RTFToolButton_obj : public ::haxe::ui::toolkit::controls::Button_obj{
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("RTFToolButton"); }
...
#endif /* INCLUDED_haxe_ui_toolkit_containers_RTFToolButton */ 
