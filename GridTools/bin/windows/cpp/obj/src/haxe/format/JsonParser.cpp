...
{
HX_STACK_FRAME("haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",12,0x6038bc92)
...
Dynamic JsonParser_obj::parseRec( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",18,0x6038bc92)
	HX_STACK_THIS(this)
	HX_STACK_LINE(18)
	while((true)){
		HX_STACK_LINE(19)
		...
		switch( (int)(c)){
			...
			case (int)123: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",24,0x6038bc92)
						{
			...
			case (int)116: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::format::JsonParser_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",70,0x6038bc92)
						{
							HX_STACK_LINE(70)
			...
			case (int)102: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::format::JsonParser_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",77,0x6038bc92)
						{
							HX_STACK_LINE(77)
							int index = (__this->pos)++;		HX_STACK_VAR(index,"index");
							HX_STACK_LINE(77)
			...
			case (int)110: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::format::JsonParser_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",84,0x6038bc92)
						{
							HX_STACK_LINE(84)
							int index = (__this->pos)++;		HX_STACK_VAR(index,"index");
							HX_STACK_LINE(84)
...
::String JsonParser_obj::parseString( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",99,0x6038bc92)
	HX_STACK_THIS(this)
	HX_STACK_LINE(100)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",202,0x6038bc92)
		HX_STACK_THIS(this)
		HX_STACK_LINE(203)
		(this->pos)--;
		HX_STACK_LINE(204)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","F:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",208,0x6038bc92)
		HX_STACK_THIS(this)
