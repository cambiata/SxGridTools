...
HX_STACK_FRAME("haxe.ui.toolkit.layout.Layout","new",0x3c7676fe,"haxe.ui.toolkit.layout.Layout.new","haxe/ui/toolkit/layout/Layout.hx",10,0xbf2052b2)
{
	...
	HX_STACK_LINE(17)
	this->_padding = ::flash::geom::Rectangle_obj::__new(null(),null(),null(),null());
}
;
	return null();
}
...
::flash::geom::Rectangle Layout_obj::get_padding( ){
...
::flash::geom::Rectangle Layout_obj::set_padding( ::flash::geom::Rectangle value){
...
Void Layout_obj::refresh( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(72)
		if (((  (((this->get_container() != null()))) ? bool(this->get_container()->__Field(HX_CSTRING("get_ready"),true)()) : bool(false) ))){
			HX_STACK_LINE(73)
			this->resizeChildren();
			HX_STACK_LINE(74)
...
Float Layout_obj::get_innerWidth( ){
	...
	HX_STACK_LINE(97)
	Float icx = (_g - ((_g1 + this->get_padding()->get_right())));		HX_STACK_VAR(icx,"icx");
	HX_STACK_LINE(98)
	return icx;
}
...
Float Layout_obj::get_innerHeight( ){
	...
	HX_STACK_LINE(106)
	Float icy = (_g - ((_g1 + this->get_padding()->get_bottom())));		HX_STACK_VAR(icy,"icy");
	HX_STACK_LINE(107)
	return icy;
}
...
Dynamic Layout_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_padding") ) { _padding=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::geom::Rectangle*/ ,(int)offsetof(Layout_obj,_padding),HX_CSTRING("_padding")},
