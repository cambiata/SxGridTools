...
{
		HX_STACK_LINE(26)
		::flash::display::Stage target = ::flash::Lib_obj::get_current()->get_stage();		HX_STACK_VAR(target,"target");
		HX_STACK_LINE(27)
...
::haxe::ui::toolkit::core::Screen Screen_obj::get_instance( ){
	...
	if (((::haxe::ui::toolkit::core::Screen_obj::_instance == null()))){
		HX_STACK_LINE(10)
		::haxe::ui::toolkit::core::Screen_obj::_instance = ::haxe::ui::toolkit::core::Screen_obj::__new();
	}
	HX_STACK_LINE(12)
