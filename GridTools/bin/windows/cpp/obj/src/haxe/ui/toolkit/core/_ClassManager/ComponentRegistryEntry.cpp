...
{
HX_STACK_FRAME("haxe.ui.toolkit.core._ClassManager.ComponentRegistryEntry","new",0x8869a691,"haxe.ui.toolkit.core._ClassManager.ComponentRegistryEntry.new","haxe/ui/toolkit/core/ClassManager.hx",121,0xd34ec19c)
{
	HX_STACK_LINE(121)
	super::__construct();
}
