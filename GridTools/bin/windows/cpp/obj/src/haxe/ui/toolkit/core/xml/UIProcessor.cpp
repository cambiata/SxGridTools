...
Dynamic UIProcessor_obj::process( ::Xml node){
	...
	if (((className != null()))){
		HX_STACK_LINE(50)
		result = ::haxe::ui::toolkit::core::xml::UIProcessor_obj::createComponent(className,node);
	}
	HX_STACK_LINE(52)
	return result;
}
	...
	for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(config->attributes());  __it->hasNext(); ){
		::String attr = __it->next();
		{
			...
			if ((::haxe::ui::toolkit::hscript::ScriptUtils_obj::isScript(value))){
				HX_STACK_LINE(65)
				value = ::haxe::ui::toolkit::hscript::ScriptManager_obj::get_instance()->executeScript(value);
			}
			HX_STACK_LINE(68)
			if (((attr == HX_CSTRING("width")))){
				...
				if (((widthString != null()))){
					HX_STACK_LINE(73)
					width = ::Std_obj::parseFloat(widthString);
					HX_STACK_LINE(74)
					if (((widthString.indexOf(HX_CSTRING("%"),null()) != (int)-1))){
						HX_STACK_LINE(75)
						width = (int)0;
						HX_STACK_LINE(76)
						percentWidth = ::Std_obj::parseFloat(widthString.substr((int)0,(widthString.length - (int)1)));
					}
				}
				HX_STACK_LINE(80)
				if (((width != (int)0))){
				...
				if (((attr == HX_CSTRING("height")))){
					...
					if (((heightString != null()))){
						HX_STACK_LINE(91)
						height = ::Std_obj::parseFloat(heightString);
						HX_STACK_LINE(92)
						if (((heightString.indexOf(HX_CSTRING("%"),null()) != (int)-1))){
							HX_STACK_LINE(93)
							height = (int)0;
							HX_STACK_LINE(94)
							percentHeight = ::Std_obj::parseFloat(heightString.substr((int)0,(heightString.length - (int)1)));
						}
					}
					HX_STACK_LINE(98)
					if (((height != (int)0))){
						...
						if (((attr == HX_CSTRING("condition")))){
							...
							if (((attr == HX_CSTRING("layout")))){
								...
								if (  ( _switch_1==HX_CSTRING("absolute"))){
									HX_STACK_LINE(117)
									c->set_layout(::haxe::ui::toolkit::layout::AbsoluteLayout_obj::__new());
									HX_STACK_LINE(117)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("box"))){
									HX_STACK_LINE(118)
									c->set_layout(::haxe::ui::toolkit::layout::BoxLayout_obj::__new());
									HX_STACK_LINE(118)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("grid"))){
									HX_STACK_LINE(119)
									c->set_layout(::haxe::ui::toolkit::layout::GridLayout_obj::__new());
									HX_STACK_LINE(119)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("horizontal"))){
									HX_STACK_LINE(120)
									c->set_layout(::haxe::ui::toolkit::layout::HorizontalLayout_obj::__new());
									HX_STACK_LINE(120)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("vertical"))){
									HX_STACK_LINE(121)
									c->set_layout(::haxe::ui::toolkit::layout::VerticalLayout_obj::__new());
									HX_STACK_LINE(121)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("continuousVertical"))){
									HX_STACK_LINE(122)
									c->set_layout(::haxe::ui::toolkit::layout::VerticalContinuousLayout_obj::__new());
									HX_STACK_LINE(122)
									break;
								}
								else if (  ( _switch_1==HX_CSTRING("continuousHorizontal"))){
									HX_STACK_LINE(123)
									c->set_layout(::haxe::ui::toolkit::layout::HorizontalContinuousLayout_obj::__new());
									HX_STACK_LINE(123)
									break;
								}
								else  {
									HX_STACK_LINE(124)
									c->set_layout(::haxe::ui::toolkit::layout::DefaultLayout_obj::__new());
									HX_STACK_LINE(124)
									break;
								}
;
;
								...
								if (((attr == HX_CSTRING("dataSource")))){
									...
									if ((::Std_obj::is(c,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDataComponent >()))){
										...
										if (((registeredDataSource != null()))){
											...
											if (((n != (int)-1))){
												...
												HX_STACK_LINE(136)
												value = value.substr((n + (int)3),value.length);
												HX_STACK_LINE(137)
												...
												HX_STACK_LINE(138)
												::Class _g1 = ::Type_obj::resolveClass(className1);		HX_STACK_VAR(_g1,"_g1");
												HX_STACK_LINE(138)
												::haxe::ui::toolkit::data::IDataSource ds = ::Type_obj::createInstance(_g1,Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(ds,"ds");
												HX_STACK_LINE(139)
												if (((ds != null()))){
													HX_STACK_LINE(140)
									...
									if (((attr == HX_CSTRING("text")))){
										...
										{
											HX_STACK_LINE(151)
											if (((::Std_obj::parseInt(value) != null()))){
												HX_STACK_LINE(152)
										...
										catch(Dynamic __e){
											{
												...
												Dynamic e = __e;{
													HX_STACK_LINE(159)
													::String _g2 = ((((HX_CSTRING("Exception setting component property: ") + attr) + HX_CSTRING(" (")) + ::Std_obj::string(e)) + HX_CSTRING(")"));		HX_STACK_VAR(_g2,"_g2");
													HX_STACK_LINE(159)
													::haxe::Log_obj::trace(_g2,hx::SourceInfo(HX_CSTRING("UIProcessor.hx"),159,HX_CSTRING("haxe.ui.toolkit.core.xml.UIProcessor"),HX_CSTRING("createComponent")));
												}
											}
										}
									}
