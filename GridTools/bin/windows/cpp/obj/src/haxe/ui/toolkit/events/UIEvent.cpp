...
{
HX_STACK_FRAME("haxe.ui.toolkit.events.UIEvent","new",0x17c22785,"haxe.ui.toolkit.events.UIEvent.new","haxe/ui/toolkit/events/UIEvent.hx",42,0x2669ff0b)
...
::flash::events::Event UIEvent_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.events.UIEvent","clone",0xd9713dc2,"haxe.ui.toolkit.events.UIEvent.clone","haxe/ui/toolkit/events/UIEvent.hx",47,0x2669ff0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
	...
	HX_STACK_LINE(48)
	::haxe::ui::toolkit::events::UIEvent c = ::haxe::ui::toolkit::events::UIEvent_obj::__new(_g,this->_component,_g1,this->get_cancelable());		HX_STACK_VAR(c,"c");
	HX_STACK_LINE(49)
...
::haxe::ui::toolkit::core::Component UIEvent_obj::get_component( ){
	HX_STACK_FRAME("haxe.ui.toolkit.events.UIEvent","get_component",0xf43e5bf9,"haxe.ui.toolkit.events.UIEvent.get_component","haxe/ui/toolkit/events/UIEvent.hx",57,0x2669ff0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(58)
	...
	HX_STACK_LINE(61)
	if (((  ((!(((this->displayObject == null()))))) ? bool((::Std_obj::is(this->displayObject,hx::ClassOf< ::haxe::ui::toolkit::core::Component >()) == false)) : bool(true) ))){
		HX_STACK_LINE(62)
		return null();
	}
	HX_STACK_LINE(64)
...
Dynamic UIEvent_obj::getComponentAs( ::Class type){
	HX_STACK_FRAME("haxe.ui.toolkit.events.UIEvent","getComponentAs",0xfa9bc714,"haxe.ui.toolkit.events.UIEvent.getComponentAs","haxe/ui/toolkit/events/UIEvent.hx",67,0x2669ff0b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(68)
...
Dynamic UIEvent_obj::getDataAs( ::Class type){
	HX_STACK_FRAME("haxe.ui.toolkit.events.UIEvent","getDataAs",0xcabf37d7,"haxe.ui.toolkit.events.UIEvent.getDataAs","haxe/ui/toolkit/events/UIEvent.hx",76,0x2669ff0b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(77)
