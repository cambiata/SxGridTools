...
bool FilesDataSource_obj::isDir( ::String dir){
	...
	HX_STACK_CATCHABLE(Dynamic, 0);
	{
		...
		HX_STACK_LINE(75)
		isDir = ::sys::FileSystem_obj::isDirectory(dir);
	}
	}
	catch(Dynamic __e){
		{
...
::String FilesDataSource_obj::fixDir( ::String dir){
	...
	HX_STACK_LINE(100)
	fixedDir = ::StringTools_obj::replace(fixedDir,HX_CSTRING("\\"),HX_CSTRING("/"));
	HX_STACK_LINE(102)
	if (((  ((!(((fixedDir.lastIndexOf(HX_CSTRING("/"),null()) == (fixedDir.length - (int)1)))))) ? bool((fixedDir.lastIndexOf(HX_CSTRING("\\"),null()) == (fixedDir.length - (int)1))) : bool(true) ))){
		HX_STACK_LINE(103)
		fixedDir = fixedDir.substr((int)0,(fixedDir.length - (int)1));
	}
	HX_STACK_LINE(106)
	return fixedDir;
}
