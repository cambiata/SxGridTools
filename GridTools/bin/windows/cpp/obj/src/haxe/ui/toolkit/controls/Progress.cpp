...
HX_STACK_FRAME("haxe.ui.toolkit.controls.Progress","new",0x89f92e35,"haxe.ui.toolkit.controls.Progress.new","haxe/ui/toolkit/controls/Progress.hx",20,0x8f3b099b)
{
	...
	HX_STACK_LINE(34)
	this->_valueBgComp = ::haxe::ui::toolkit::core::StateComponent_obj::__new();
	HX_STACK_LINE(35)
	...
	HX_STACK_LINE(37)
	this->_valueComp = ::haxe::ui::toolkit::core::StateComponent_obj::__new();
	HX_STACK_LINE(38)
...
::String Progress_obj::set_direction( ::String value){
	...
	if (((value == HX_CSTRING("horizontal")))){
		HX_STACK_LINE(94)
		this->_layout = ::haxe::ui::toolkit::controls::HProgressLayout_obj::__new();
	}
	else{
		HX_STACK_LINE(95)
		if (((value == HX_CSTRING("vertical")))){
			HX_STACK_LINE(96)
			this->_layout = ::haxe::ui::toolkit::controls::VProgressLayout_obj::__new();
		}
	}
	HX_STACK_LINE(98)
	return value;
