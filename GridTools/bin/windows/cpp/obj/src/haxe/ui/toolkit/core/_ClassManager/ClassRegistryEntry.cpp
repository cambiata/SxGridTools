...
{
HX_STACK_FRAME("haxe.ui.toolkit.core._ClassManager.ClassRegistryEntry","new",0x98d0a536,"haxe.ui.toolkit.core._ClassManager.ClassRegistryEntry.new","haxe/ui/toolkit/core/ClassManager.hx",113,0xd34ec19c)
{
}
;
	return null();
