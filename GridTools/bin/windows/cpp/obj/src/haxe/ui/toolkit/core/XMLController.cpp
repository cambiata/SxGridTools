...
{
HX_STACK_FRAME("haxe.ui.toolkit.core.XMLController","new",0x89c4b918,"haxe.ui.toolkit.core.XMLController.new","haxe/ui/toolkit/core/XMLController.hx",8,0xe67ef318)

HX_STACK_ARG(xmlResourceId,"xmlResourceId")
{
	HX_STACK_LINE(8)
	super::__construct(::haxe::ui::toolkit::core::Toolkit_obj::processXml(::Xml_obj::parse(::haxe::ui::toolkit::resources::ResourceManager_obj::get_instance()->getText(xmlResourceId,null()))),null());
}
;
	return null();
}
