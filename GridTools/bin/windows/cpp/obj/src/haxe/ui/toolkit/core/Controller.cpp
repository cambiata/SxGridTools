...
HX_STACK_ARG(options,"options")
{
	...
	if ((::Std_obj::is(view,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >()))){
		HX_STACK_LINE(20)
		this->_view = hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >::cast(view);
	}
	else{
		HX_STACK_LINE(21)
		if ((::Std_obj::is(view,hx::ClassOf< ::Class >()))){
			...
			HX_STACK_LINE(23)
			this->_view = ::Type_obj::createInstance(cls,Dynamic( Array_obj<Dynamic>::__new()));
		}
		else{
			HX_STACK_LINE(24)
			if (((view != null()))){
	...
	if (((this->_view == null()))){
		HX_STACK_LINE(29)
		this->_view = ::haxe::ui::toolkit::core::Component_obj::__new();
	}
	HX_STACK_LINE(32)
	if (((options != null()))){
		HX_STACK_LINE(33)
		...
		while(((_g < _g1->length))){
			...
			struct _Function_3_1{
				inline static Dynamic Block( ::haxe::ui::toolkit::core::Controller_obj *__this,::String &f){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ui/toolkit/core/Controller.hx",34,0xc6f4a5b5)
					{
						HX_STACK_LINE(34)
						Dynamic o = __this->_view;		HX_STACK_VAR(o,"o");
						HX_STACK_LINE(34)
						return (  (((o == null()))) ? Dynamic(null()) : Dynamic(o->__Field((HX_CSTRING("set_") + f),true)) );
					}
					return null();
				}
			};
			HX_STACK_LINE(34)
			if (((_Function_3_1::Block(this,f) != null()))){
				HX_STACK_LINE(35)
...
Dynamic Controller_obj::addChild( Dynamic child,Dynamic options){
	...
	if ((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObject >()))){
		HX_STACK_LINE(46)
		childObject = hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObject >::cast(child);
	}
	else{
		HX_STACK_LINE(47)
		if ((::Std_obj::is(child,hx::ClassOf< ::Class >()))){
			...
			HX_STACK_LINE(49)
			childObject = ::Type_obj::createInstance(cls,Dynamic( Array_obj<Dynamic>::__new()));
		}
		else{
			HX_STACK_LINE(50)
			if (((child != null()))){
	...
	if (((childObject == null()))){
		HX_STACK_LINE(55)
		childObject = ::haxe::ui::toolkit::core::Component_obj::__new();
	}
	HX_STACK_LINE(58)
	if (((options != null()))){
		HX_STACK_LINE(59)
		...
		while(((_g < _g1->length))){
			...
			++(_g);
			HX_STACK_LINE(60)
			if (((((  (((childObject == null()))) ? Dynamic(null()) : Dynamic(childObject->__Field((HX_CSTRING("set_") + f),true)) )) != null()))){
				HX_STACK_LINE(61)
				Dynamic value = ::Reflect_obj::field(options,f);		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(61)
				if (((childObject != null()))){
...
Void Controller_obj::refereshNamedComponents( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(106)
		this->_namedComponents = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(107)
...
Void Controller_obj::addNamedComponentsFrom( ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer parent){
{
		...
		HX_STACK_LINE(115)
		if (((  (((parent != null()))) ? bool((parent->__Field(HX_CSTRING("get_id"),true)() != null())) : bool(false) ))){
			HX_STACK_LINE(116)
			this->_namedComponents->set(parent->__Field(HX_CSTRING("get_id"),true)(),parent);
		}
		HX_STACK_LINE(119)
		{
			HX_STACK_LINE(119)
			...
			while(((_g < _g1->length))){
				...
				++(_g);
				HX_STACK_LINE(120)
				this->addNamedComponentsFrom(hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >::cast(child));
			}
		}
	}
return null();
...
::haxe::ui::toolkit::controls::popups::Popup Controller_obj::get_popup( ){
	...
	HX_STACK_LINE(137)
	if ((::Std_obj::is(this->get_view()->__Field(HX_CSTRING("get_parent"),true)(),hx::ClassOf< ::haxe::ui::toolkit::controls::popups::PopupContent >()))){
		HX_STACK_LINE(138)
	...
	HX_STACK_ARG(fn,"fn")
{
		...
		if ((::Std_obj::is(content,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObject >()))){
			HX_STACK_LINE(159)
			display = hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObject >::cast(content);
		}
		else{
			HX_STACK_LINE(160)
			if ((::Std_obj::is(content,hx::ClassOf< ::String >()))){
				HX_STACK_LINE(161)
				display = ::haxe::ui::toolkit::core::Toolkit_obj::processXmlResource(hx::TCast< String >::cast(content));
			}
		}
		HX_STACK_LINE(163)
		if (((display == null()))){
