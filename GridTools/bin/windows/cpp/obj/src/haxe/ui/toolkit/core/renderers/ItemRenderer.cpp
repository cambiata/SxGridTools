...
Void ItemRenderer_obj::addStatesRecursively( ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer c){
{
		...
		if (((  ((::Std_obj::is(c,hx::ClassOf< ::haxe::ui::toolkit::core::StateComponent >()))) ? bool((c != hx::ObjectPtr<OBJ_>(this))) : bool(false) ))){
			HX_STACK_LINE(37)
			(hx::TCast< haxe::ui::toolkit::core::StateComponent >::cast(c))->addStates(this->get_states(),null());
		}
		HX_STACK_LINE(40)
		{
			HX_STACK_LINE(40)
			...
			while(((_g < _g1->length))){
				...
				if ((::Std_obj::is(c,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >()))){
					HX_STACK_LINE(46)
					this->addStatesRecursively(hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >::cast(child));
				}
			}
		}
	}
...
bool ItemRenderer_obj::allowSelection( Float stageX,Float stageY){
	...
	while(((c != null()))){
		...
		HX_STACK_LINE(76)
		if (((::Std_obj::is(c,hx::ClassOf< ::haxe::ui::toolkit::core::DisplayObjectContainer >()) == false))){
			HX_STACK_LINE(77)
			break;
		}
		HX_STACK_LINE(79)
		c = (hx::TCast< haxe::ui::toolkit::core::DisplayObjectContainer >::cast(c))->findComponentUnderPoint(stageX,stageY);
	}
	HX_STACK_LINE(81)
	return allow;
}
		...
		while(((_g < _g1->length))){
			...
			if ((this->isInteractive(child))){
				...
				if ((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >()))){
					HX_STACK_LINE(90)
					this->attachEvents(hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >::cast(child));
				}
			}
		}
	}
...
Void ItemRenderer_obj::_onComponentEvent( ::haxe::ui::toolkit::events::UIEvent event){
{
		...
		HX_STACK_LINE(107)
		if (((  (((  (((event->get_component() != null()))) ? bool((event->get_component()->get_id() != null())) : bool(false) ))) ? bool((event->get_component()->get_id().length > (int)0)) : bool(false) ))){
			HX_STACK_LINE(108)
...
Void ItemRenderer_obj::dispatchProxyEvent( ::String type,::haxe::ui::toolkit::events::UIEvent refEvent){
{
		...
		if (((this->eventDispatcher != null()))){
			...
			HX_STACK_LINE(117)
			if (((  (((refEvent != null()))) ? bool((refEvent->get_component() != null())) : bool(false) ))){
				HX_STACK_LINE(118)
				c = refEvent->get_component();
			}
			HX_STACK_LINE(120)
...
Void ItemRenderer_obj::setStateRecursively( ::String value,::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer c){
{
		...
		HX_STACK_LINE(163)
		{
			...
			while(((_g < _g1->length))){
				...
				if ((::Std_obj::is(c,hx::ClassOf< ::haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >()))){
					HX_STACK_LINE(169)
					this->setStateRecursively(value,hx::TCast< haxe::ui::toolkit::core::interfaces::IDisplayObjectContainer >::cast(child));
				}
			}
		}
	}
...
Dynamic ItemRenderer_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.core.renderers.ItemRenderer","clone",0x705f7bd0,"haxe.ui.toolkit.core.renderers.ItemRenderer.clone","haxe/ui/toolkit/core/Macros.hx",257,0x3fba9eca)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1)
	...
	HX_STACK_LINE(185)
	{
		...
		while(((_g < _g1->length))){
			...
			++(_g);
			HX_STACK_LINE(186)
			c->addChild(child->__Field(HX_CSTRING("clone"),true)());
		}
	}
	HX_STACK_LINE(1)
	return c;
