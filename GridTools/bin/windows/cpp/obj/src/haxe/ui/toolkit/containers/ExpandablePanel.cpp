...
::haxe::ui::toolkit::core::interfaces::IDisplayObject ExpandablePanel_obj::addChild( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child){
	...
	if (((this->_button == null()))){
		HX_STACK_LINE(36)
		this->_button = ::haxe::ui::toolkit::containers::ExpandableButton_obj::__new();
		HX_STACK_LINE(37)
	...
	if (((this->_panel == null()))){
		HX_STACK_LINE(47)
		this->_panel = ::haxe::ui::toolkit::containers::VBox_obj::__new();
		HX_STACK_LINE(48)
		...
		HX_STACK_LINE(51)
		this->_panel->addEventListener(::flash::events::Event_obj::ADDED_TO_STAGE,this->panelAdded_dyn(),null(),null(),null());
	}
	HX_STACK_LINE(56)
...
Void ExpandablePanel_obj::panelAdded( ::flash::events::Event e){
{
		...
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(68)
		this->removeEventListener(::flash::events::Event_obj::ADDED_TO_STAGE,this->panelAdded_dyn(),null());
		HX_STACK_LINE(70)
...
Void ExpandablePanel_obj::showPanel( ){
{
		...
		if (((transition == HX_CSTRING("slide")))){
			...
			HX_STACK_LINE(88)
			::motion::Actuate_obj::tween(this->_panel,.2,_Function_2_1::Block(finalH),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onUpdate( Dynamic(new _Function_2_2(_g)),null());
		}
		else{
			HX_STACK_LINE(92)
			this->_panel->set_visible(true);
...
Void ExpandablePanel_obj::hidePanel( ){
{
		...
		if (((transition == HX_CSTRING("slide")))){
			...
			HX_STACK_LINE(101)
			::motion::Actuate_obj::tween(this->_panel,.2,_Function_2_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onUpdate( Dynamic(new _Function_2_2(_g)),null())->onComplete( Dynamic(new _Function_2_3(_g)),null());
		}
		else{
			HX_STACK_LINE(105)
			this->_panel->set_visible(false);
