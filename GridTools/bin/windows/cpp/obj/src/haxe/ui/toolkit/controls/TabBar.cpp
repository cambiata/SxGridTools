...
HX_STACK_FRAME("haxe.ui.toolkit.controls.TabBar","new",0xc361d406,"haxe.ui.toolkit.controls.TabBar.new","haxe/ui/toolkit/controls/TabBar.hx",14,0xaef198ea)
{
	...
	HX_STACK_LINE(24)
	this->_content = ::haxe::ui::toolkit::containers::HBox_obj::__new();
	HX_STACK_LINE(25)
	this->_content->set_id(HX_CSTRING("content"));
	HX_STACK_LINE(26)
	this->_content->set_percentHeight((int)100);
	HX_STACK_LINE(27)
	this->_content->addEventListener(::flash::events::MouseEvent_obj::MOUSE_WHEEL,this->_onMouseWheel_dyn(),null(),null(),null());
	HX_STACK_LINE(28)
	...
	if (((value != this->_selectedIndex))){
		HX_STACK_LINE(53)
		{
			...
			while(((_g1 < _g))){
				...
				HX_STACK_LINE(54)
				button = hx::TCast< haxe::ui::toolkit::controls::Button >::cast(this->_content->get_children()->__get(n));
				HX_STACK_LINE(55)
				if (((n == value))){
					HX_STACK_LINE(56)
...
Void TabBar_obj::removeTab( int index){
{
		...
		HX_STACK_LINE(95)
		if (((newIndex > (this->_content->get_numChildren() - (int)1)))){
			HX_STACK_LINE(96)
			newIndex = (this->_content->get_numChildren() - (int)1);
		}
		HX_STACK_LINE(98)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.controls.TabBar","tabButtonClick",0x461912bb,"haxe.ui.toolkit.controls.TabBar.tabButtonClick","haxe/ui/toolkit/controls/TabBar.hx",117,0xaef198ea)
		HX_STACK_THIS(this)
...
Void TabBar_obj::_onMouseWheel( ::flash::events::MouseEvent event){
{
		...
		struct _Function_1_1{
			inline static bool Block( ::haxe::ui::toolkit::controls::TabBar_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ui/toolkit/controls/TabBar.hx",127,0xaef198ea)
				{
					...
					HX_STACK_LINE(127)
					return (_g > __this->get_layout()->__Field(HX_CSTRING("get_usableWidth"),true)());
				}
				return null();
			}
		};
