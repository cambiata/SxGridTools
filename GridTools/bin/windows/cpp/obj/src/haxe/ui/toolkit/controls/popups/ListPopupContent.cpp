...
Void ListPopupContent_obj::initialize( ){
{
		...
		HX_STACK_LINE(48)
		Float _g = (n * this->_list->get_itemHeight());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(48)
		Float _g1 = this->_list->get_layout()->__Field(HX_CSTRING("get_padding"),true)()->__Field(HX_CSTRING("get_top"),true)();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(48)
		Float listHeight = (_g + ((_g1 + this->_list->get_layout()->__Field(HX_CSTRING("get_padding"),true)()->__Field(HX_CSTRING("get_bottom"),true)())));		HX_STACK_VAR(listHeight,"listHeight");
		HX_STACK_LINE(49)
...
int ListPopupContent_obj::get_selectedIndex( ){
	...
	if ((this->_list->get_ready())){
		HX_STACK_LINE(63)
		index = this->_list->get_selectedIndex();
	}
	HX_STACK_LINE(65)
	return index;
}
...
Void ListPopupContent_obj::_onListChange( ::haxe::ui::toolkit::events::UIEvent event){
{
		...
		HX_STACK_LINE(92)
		this->hideTimer = ::flash::utils::Timer_obj::__new(this->DELAY,(int)1);
		HX_STACK_LINE(93)
		this->hideTimer->addEventListener(::flash::events::TimerEvent_obj::TIMER_COMPLETE,this->_onTimerComplete_dyn(),null(),null(),null());
		HX_STACK_LINE(94)
...
Void ListPopupContent_obj::_onTimerComplete( ::flash::events::TimerEvent event){
{
		...
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(98)
		this->hideTimer->removeEventListener(::flash::events::TimerEvent_obj::TIMER_COMPLETE,this->_onTimerComplete_dyn(),null());
		HX_STACK_LINE(99)
		if ((::Std_obj::is(this->get_parent(),hx::ClassOf< ::haxe::ui::toolkit::controls::popups::Popup >()))){
			HX_STACK_LINE(100)
			::haxe::ui::toolkit::core::PopupManager_obj::get_instance()->hidePopup(hx::TCast< haxe::ui::toolkit::controls::popups::Popup >::cast(this->get_parent()),null());
		}
		HX_STACK_LINE(103)
		if (((this->_fn_dyn() != null()))){
			HX_STACK_LINE(104)
			::haxe::ui::toolkit::core::interfaces::IItemRenderer item = this->_list->get_selectedItems()->__get((int)0);		HX_STACK_VAR(item,"item");
			HX_STACK_LINE(105)
...
Dynamic ListPopupContent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"hideTimer") ) { hideTimer=inValue.Cast< ::flash::utils::Timer >(); return inValue; }
		break;
	case 12:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::utils::Timer*/ ,(int)offsetof(ListPopupContent_obj,hideTimer),HX_CSTRING("hideTimer")},
