...
Void VProgressLayout_obj::resizeChildren( ){
{
		...
		if (((background != null()))){
			HX_STACK_LINE(250)
			value = background->findChild(HX_CSTRING("value"),null(),null());
		}
		HX_STACK_LINE(253)
		...
		if (((value != null()))){
			...
			if (((thumb != null()))){
				HX_STACK_LINE(259)
				hx::SubEq(ucy,thumb->__Field(HX_CSTRING("get_height"),true)());
			}
			HX_STACK_LINE(262)
			value->__Field(HX_CSTRING("set_percentHeight"),true)((int)-1);
			HX_STACK_LINE(263)
			Float _g = scroll->__Field(HX_CSTRING("get_pos"),true)();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(263)
			Float _g1 = (_g - scroll->__Field(HX_CSTRING("get_min"),true)());		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(263)
			Float _g2 = scroll->__Field(HX_CSTRING("get_max"),true)();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(263)
			Float cy = ((Float(_g1) / Float(((_g2 - scroll->__Field(HX_CSTRING("get_min"),true)())))) * ucy);		HX_STACK_VAR(cy,"cy");
			HX_STACK_LINE(265)
			if (((cy < (int)0))){
				HX_STACK_LINE(266)
				cy = (int)0;
			...
			if (((thumb != null()))){
				HX_STACK_LINE(272)
				hx::AddEq(cy,(Float(thumb->__Field(HX_CSTRING("get_height"),true)()) / Float((int)2)));
			}
			HX_STACK_LINE(275)
			if (((cy == (int)0))){
				HX_STACK_LINE(276)
...
Void VProgressLayout_obj::repositionChildren( ){
{
		...
		if (((background != null()))){
			HX_STACK_LINE(290)
			Float _g = (Float(this->get_container()->__Field(HX_CSTRING("get_width"),true)()) / Float((int)2));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(290)
			background->set_x((_g - (Float(background->get_width()) / Float((int)2))));
			HX_STACK_LINE(291)
			value = background->findChild(HX_CSTRING("value"),null(),null());
		}
		HX_STACK_LINE(294)
		...
		if (((value != null()))){
			...
			Float ucy = this->get_usableHeight();		HX_STACK_VAR(ucy,"ucy");
			HX_STACK_LINE(297)
			Float _g1 = (ucy - value->__Field(HX_CSTRING("get_height"),true)());		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(297)
			value->__Field(HX_CSTRING("set_y"),true)((_g1 - background->get_layout()->__Field(HX_CSTRING("get_padding"),true)()->__Field(HX_CSTRING("get_bottom"),true)()));
			HX_STACK_LINE(299)
			::haxe::ui::toolkit::core::interfaces::IDisplayObject thumb = this->get_container()->findChild(HX_CSTRING("thumb"),null(),null());		HX_STACK_VAR(thumb,"thumb");
			HX_STACK_LINE(300)
			if (((thumb != null()))){
				HX_STACK_LINE(301)
				Float _g2 = value->__Field(HX_CSTRING("get_y"),true)();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(301)
				Float ypos = (_g2 - (Float(thumb->__Field(HX_CSTRING("get_height"),true)()) / Float((int)2)));		HX_STACK_VAR(ypos,"ypos");
				HX_STACK_LINE(302)
				thumb->__Field(HX_CSTRING("set_y"),true)(::Std_obj::_int(ypos));
			}
		}
	}
return null();
