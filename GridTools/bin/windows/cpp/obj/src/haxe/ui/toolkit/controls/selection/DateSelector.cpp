...
Void DateSelector_obj::_onMouseClick( ::flash::events::MouseEvent event){
{
		...
		HX_STACK_LINE(44)
		if (((  ((!(((this->_cal == null()))))) ? bool((this->_cal->get_visible() == false)) : bool(true) ))){
			HX_STACK_LINE(45)
			this->showCalendar();
		}
		else{
...
Void DateSelector_obj::showCalendar( ){
{
		...
		if (((this->_method == HX_CSTRING("popup")))){
			...
			if (((this->_cal == null()))){
				HX_STACK_LINE(75)
				this->_cal = ::haxe::ui::toolkit::containers::CalendarView_obj::__new();
				HX_STACK_LINE(76)
				this->_cal->addEventListener(::flash::events::Event_obj::CHANGE,this->onDateChange_dyn(),null(),null(),null());
				...
				HX_STACK_LINE(77)
				this->_cal->addEventListener(::flash::events::Event_obj::ADDED_TO_STAGE, Dynamic(new _Function_3_1(_g)),null(),null(),null());
				HX_STACK_LINE(80)
			...
			HX_STACK_LINE(87)
			this->_cal->set_x((_g1 - this->get_root()->get_stageX()));
			HX_STACK_LINE(88)
			Float _g11 = this->get_stageY();		HX_STACK_VAR(_g11,"_g11");
			HX_STACK_LINE(88)
			Float _g2 = (_g11 + this->get_height());		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(88)
			this->_cal->set_y((_g2 - this->get_root()->get_stageY()));
			HX_STACK_LINE(89)
			this->_cal->get_sprite()->set_filters(Dynamic( Array_obj<Dynamic>::__new().Add(::flash::filters::DropShadowFilter_obj::__new((int)4,(int)45,(int)8421504,(int)1,(int)4,(int)4,(int)1,(int)3,null(),null(),null()))));
			HX_STACK_LINE(91)
			...
			if (((transition == HX_CSTRING("slide")))){
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::haxe::ui::toolkit::controls::selection::DateSelector_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ui/toolkit/controls/selection/DateSelector.hx",96,0x0ade2058)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("clipHeight") , __this->_cal->get_height(),false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(96)
				::motion::Actuate_obj::tween(this->_cal,.1,_Function_3_1::Block(this),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_3_2(_g)),null());
			}
			else{
				HX_STACK_LINE(99)
				if (((transition == HX_CSTRING("fade")))){
					...
					this->_cal->set_visible(true);
					HX_STACK_LINE(102)
					::flash::display::Sprite _g3 = this->_cal->get_sprite();		HX_STACK_VAR(_g3,"_g3");
					...
					HX_STACK_LINE(102)
					::motion::Actuate_obj::tween(_g3,.2,_Function_4_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_4_2()),null());
				}
				else{
					HX_STACK_LINE(105)
					this->_cal->get_sprite()->set_alpha((int)1);
...
Void DateSelector_obj::hideCalendar( ){
{
		...
		if (((this->_cal != null()))){
			...
			if (((transition == HX_CSTRING("slide")))){
				...
				HX_STACK_LINE(118)
				::motion::Actuate_obj::tween(this->_cal,.1,_Function_3_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_3_2(_g)),null());
			}
			else{
				HX_STACK_LINE(122)
				if (((transition == HX_CSTRING("fade")))){
					HX_STACK_LINE(123)
					::flash::display::Sprite _g1 = this->_cal->get_sprite();		HX_STACK_VAR(_g1,"_g1");
					struct _Function_4_1{
						inline static Dynamic Block( ){
...
::String DateSelector_obj::set_dateFormat( ::String value){
	...
	if (((this->_cal != null()))){
		HX_STACK_LINE(176)
		this->set_text(::DateTools_obj::format(this->_cal->get_selectedDate(),this->dateFormat));
	}
	HX_STACK_LINE(178)
	return value;
}
...
Void DateSelector_obj::_onRootMouseDown( ::flash::events::MouseEvent event){
{
		...
		if (((this->_cal != null()))){
			HX_STACK_LINE(187)
			mouseInList = this->_cal->hitTest(event->stageX,event->stageY);
		}
		HX_STACK_LINE(190)
...
Void DateSelector_obj::onDateChange( ::flash::events::Event event){
{
		...
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(199)
		::String dateString = ::DateTools_obj::format(this->_cal->get_selectedDate(),this->dateFormat);		HX_STACK_VAR(dateString,"dateString");
		HX_STACK_LINE(200)
