...
{
HX_STACK_FRAME("haxe.ui.toolkit.core._ClassManager.DataSourceRegistryEntry","new",0xc8cc577b,"haxe.ui.toolkit.core._ClassManager.DataSourceRegistryEntry.new","haxe/ui/toolkit/core/ClassManager.hx",125,0xd34ec19c)
{
	HX_STACK_LINE(125)
	super::__construct();
}
