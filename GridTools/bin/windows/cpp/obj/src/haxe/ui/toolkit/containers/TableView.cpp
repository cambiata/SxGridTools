...
HX_STACK_FRAME("haxe.ui.toolkit.containers.TableView","new",0xd8105f4b,"haxe.ui.toolkit.containers.TableView.new","haxe/ui/toolkit/containers/TableView.hx",21,0x496fad85)
{
	...
	super::__construct();
	HX_STACK_LINE(31)
	this->_columnDefs = ::haxe::ui::toolkit::containers::TableViewColumnDefs_obj::__new();
	HX_STACK_LINE(32)
	this->set_dataSource(::haxe::ui::toolkit::data::ArrayDataSource_obj::__new());
	HX_STACK_LINE(33)
	this->_scrollView = ::haxe::ui::toolkit::containers::ScrollView_obj::__new();
	HX_STACK_LINE(34)
	...
	HX_STACK_LINE(40)
	this->_scrollContent = ::haxe::ui::toolkit::containers::VBox_obj::__new();
	HX_STACK_LINE(41)
	...
	HX_STACK_ARG(recursive,"recursive")
{
		...
		if (((bool(this->_ready) && bool((((int(type) & int((int)256))) == (int)256))))){
			HX_STACK_LINE(66)
			if (((this->_scrollView->get_layout()->__Field(HX_CSTRING("get_usableWidth"),true)() > (int)0))){
				HX_STACK_LINE(67)
				this->resizeColumns();
			}
		}
...
::haxe::ui::toolkit::data::IDataSource TableView_obj::set_dataSource( ::haxe::ui::toolkit::data::IDataSource value){
	...
	if (((this->_dataSource != null()))){
		HX_STACK_LINE(83)
		if ((::Std_obj::is(this->_dataSource,hx::ClassOf< ::flash::events::IEventDispatcher >()))){
			HX_STACK_LINE(84)
			(hx::TCast< flash::events::IEventDispatcher >::cast(this->_dataSource))->removeEventListener(::flash::events::Event_obj::CHANGE,this->_onDataSourceChanged_dyn(),null());
		}
	}
	HX_STACK_LINE(88)
	...
	if ((::Std_obj::is(this->_dataSource,hx::ClassOf< ::flash::events::IEventDispatcher >()))){
		HX_STACK_LINE(91)
		(hx::TCast< flash::events::IEventDispatcher >::cast(this->_dataSource))->addEventListener(::flash::events::Event_obj::CHANGE,this->_onDataSourceChanged_dyn(),null(),null(),null());
	}
	HX_STACK_LINE(94)
	if (((this->_ready == true))){
		HX_STACK_LINE(95)
...
Void TableView_obj::_onDataSourceChanged( ::flash::events::Event event){
{
		...
		if (((this->_dataSource != null()))){
			...
			if ((this->get_dataSource()->moveFirst())){
				...
				do{
					...
					HX_STACK_LINE(129)
					if (((this->_scrollContent->getChildAt(pos) != null()))){
						HX_STACK_LINE(130)
						item = hx::TCast< haxe::ui::toolkit::containers::TableViewRow >::cast(this->_scrollContent->getChildAt(pos));
					}
					HX_STACK_LINE(133)
					if (((item == null()))){
						HX_STACK_LINE(134)
						...
						if (((item->hash == dataHash))){
							...
							HX_STACK_LINE(140)
							while(((bool((item != null())) && bool((item->hash != dataHash))))){
								HX_STACK_LINE(142)
								item = hx::TCast< haxe::ui::toolkit::containers::TableViewRow >::cast(this->_scrollContent->getChildAt(pos));
							}
							HX_STACK_LINE(144)
	...
	HX_STACK_ARG(index,"index")
{
		...
		HX_STACK_LINE(171)
		if (((hx::Mod(this->_scrollContent->get_numChildren(),(int)2) == (int)0))){
			HX_STACK_LINE(171)
			id = HX_CSTRING("even");
		}
		else{
...
Void TableView_obj::resizeColumns( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(184)
		if (((this->_scrollContent->get_numChildren() == (int)0))){
			HX_STACK_LINE(185)
			return null();
		}
		HX_STACK_LINE(187)
		...
		HX_STACK_LINE(191)
		{
			...
			while(((_g < cols->length))){
				HX_STACK_LINE(191)
				::haxe::ui::toolkit::containers::TableViewColumnDef c = cols->__get(_g).StaticCast< ::haxe::ui::toolkit::containers::TableViewColumnDef >();		HX_STACK_VAR(c,"c");
				HX_STACK_LINE(191)
				++(_g);
				HX_STACK_LINE(192)
		...
		HX_STACK_LINE(195)
		if (((totalWidth < this->_scrollView->get_layout()->__Field(HX_CSTRING("get_usableWidth"),true)()))){
			HX_STACK_LINE(196)
			Float diff = (this->_scrollView->get_layout()->__Field(HX_CSTRING("get_usableWidth"),true)() - totalWidth);		HX_STACK_VAR(diff,"diff");
			HX_STACK_LINE(197)
			...
			HX_STACK_LINE(198)
			{
				...
				int _g = (int)0;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(198)
				Array< ::haxe::ui::toolkit::core::interfaces::IDisplayObject > _g1 = this->_scrollContent->get_children();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(198)
				while(((_g < _g1->length))){
					HX_STACK_LINE(198)
					...
					HX_STACK_LINE(200)
					temp->getChildAt((temp->get_numChildren() - (int)1))->__Field(HX_CSTRING("set_width"),true)(newWidth);
				}
			}
		}
	}
...
Void TableView_obj::handleListSelection( ::haxe::ui::toolkit::containers::TableViewRow item,::flash::events::Event event,hx::Null< bool >  __o_raiseEvent){
	...
	HX_STACK_ARG(raiseEvent,"raiseEvent")
{
		...
		if (((raiseEvent == true))){
			HX_STACK_LINE(239)
			::flash::events::Event event1 = ::flash::events::Event_obj::__new(::flash::events::Event_obj::CHANGE,null(),null());		HX_STACK_VAR(event1,"event1");
			HX_STACK_LINE(240)
...
Void TableView_obj::handleClick( ::haxe::ui::toolkit::containers::TableViewRow item,::flash::events::MouseEvent event){
{
		...
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(245)
		int index = ::Lambda_obj::indexOf(this->_scrollContent->get_children(),item);		HX_STACK_VAR(index,"index");
		HX_STACK_LINE(246)
		if (((this->_lastSelection == index))){
			HX_STACK_LINE(247)
			::flash::events::MouseEvent event1 = ::flash::events::MouseEvent_obj::__new(::flash::events::MouseEvent_obj::DOUBLE_CLICK,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(event1,"event1");
			HX_STACK_LINE(248)
			this->dispatchEvent(event1);
			HX_STACK_LINE(249)
			this->_lastSelection = (int)-1;
...
bool TableView_obj::isSelected( ::haxe::ui::toolkit::containers::TableViewRow item){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TableView","isSelected",0x807c30da,"haxe.ui.toolkit.containers.TableView.isSelected","haxe/ui/toolkit/containers/TableView.hx",256,0x496fad85)
	HX_STACK_THIS(this)
	HX_STACK_ARG(item,"item")
	HX_STACK_LINE(256)
