...
Dynamic Container_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.Container","clone",0x9830a936,"haxe.ui.toolkit.containers.Container.clone","haxe/ui/toolkit/core/Macros.hx",257,0x3fba9eca)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1)
