...
Void Text_obj::initialize( ){
{
		...
		HX_STACK_LINE(30)
		this->_textDisplay->__Field(HX_CSTRING("set_autoSize"),true)(this->get_autoSize());
		HX_STACK_LINE(31)
		this->_textDisplay->__Field(HX_CSTRING("set_text"),true)(this->get_text());
		HX_STACK_LINE(33)
		if (((this->get_autoSize() == true))){
			HX_STACK_LINE(34)
			if (((this->get_width() == (int)0))){
				HX_STACK_LINE(35)
				this->set_width(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("get_width"),true)());
			}
			HX_STACK_LINE(37)
			if (((this->get_height() == (int)0))){
				HX_STACK_LINE(38)
				this->set_height(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("get_height"),true)());
			}
		}
	}
return null();
...
Void Text_obj::dispose( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(44)
		if ((this->get_sprite()->contains(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()))){
			HX_STACK_LINE(45)
...
bool Text_obj::set_autoSize( bool value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(83)
	value = this->super::set_autoSize(value);
	HX_STACK_LINE(84)
