...
::String title = __o_title.Default(HX_CSTRING(""));
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TableViewColumnDefs","add",0x1a79a170,"haxe.ui.toolkit.containers.TableViewColumnDefs.add","haxe/ui/toolkit/containers/TableView.hx",267,0x496fad85)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
