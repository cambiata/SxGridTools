...
HX_STACK_ARG(fn,"fn")
{
	...
	if (((title != null()))){
		HX_STACK_LINE(41)
		this->_titleBar = ::haxe::ui::toolkit::containers::Box_obj::__new();
		HX_STACK_LINE(42)
	...
	if (((title != null()))){
		HX_STACK_LINE(50)
		this->_title = ::haxe::ui::toolkit::controls::Text_obj::__new();
		HX_STACK_LINE(51)
	...
	HX_STACK_LINE(55)
	this->_buttonBar = ::haxe::ui::toolkit::containers::Box_obj::__new();
	HX_STACK_LINE(56)
	...
	if (((this->_config == null()))){
		...
		HX_STACK_LINE(63)
		this->_config->__FieldRef(HX_CSTRING("buttons")) = Array_obj< ::Dynamic >::__new();
	}
	HX_STACK_LINE(65)
...
Void Popup_obj::initialize( ){
{
		...
		if (((this->_content == null()))){
			HX_STACK_LINE(90)
			this->_content = ::haxe::ui::toolkit::controls::popups::PopupContent_obj::__new();
		}
		HX_STACK_LINE(92)
		...
		if (((this->_config->__Field(HX_CSTRING("buttons"),true)->__Field(HX_CSTRING("length"),true) > (int)0))){
			...
			HX_STACK_LINE(102)
			{
				...
				while(((_g < buttons->length))){
					...
					++(_g);
					HX_STACK_LINE(103)
					if (((((int(info->__get((int)0).StaticCast< ::haxe::ui::toolkit::core::PopupButtonInfo >()->type) & int((int)1048576))) != (int)1048576))){
						HX_STACK_LINE(104)
						...
						HX_STACK_LINE(111)
						button->addEventListener(::flash::events::MouseEvent_obj::CLICK, Dynamic(new _Function_5_1(_g1,info)),null(),null(),null());
						HX_STACK_LINE(114)
						box->addChild(button);
					}
				}
...
bool Popup_obj::allowDrag( ::flash::events::MouseEvent event){
...
::haxe::ui::toolkit::controls::Button Popup_obj::createStandardButton( int v){
	...
	if (((v == (int)1))){
		HX_STACK_LINE(156)
		button = ::haxe::ui::toolkit::controls::Button_obj::__new();
		HX_STACK_LINE(157)
		...
		HX_STACK_LINE(158)
		button->addEventListener(::flash::events::MouseEvent_obj::CLICK, Dynamic(new _Function_2_1(_g)),null(),null(),null());
	}
	HX_STACK_LINE(162)
	if (((v == (int)16))){
		HX_STACK_LINE(163)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.controls.popups.Popup","clickButton",0x9c455587,"haxe.ui.toolkit.controls.popups.Popup.clickButton","haxe/ui/toolkit/controls/popups/Popup.hx",195,0x52c99b44)
		HX_STACK_THIS(this)
		HX_STACK_ARG(button,"button")
		HX_STACK_LINE(196)
		if (((this->_content->onButtonClicked(button) == true))){
			HX_STACK_LINE(197)
