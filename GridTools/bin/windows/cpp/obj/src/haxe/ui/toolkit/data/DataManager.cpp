...
{
HX_STACK_FRAME("haxe.ui.toolkit.data.DataManager","new",0x28b3b133,"haxe.ui.toolkit.data.DataManager.new","haxe/ui/toolkit/data/DataManager.hx",27,0xfa43c75d)
{
	HX_STACK_LINE(27)
	this->_dataSourceMap = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
...
Void DataManager_obj::registerDataSource( ::haxe::ui::toolkit::data::IDataSource dataSource){
{
		...
		if (((bool((dataSourceId == null())) || bool((dataSourceId.length == (int)0))))){
			HX_STACK_LINE(37)
			dataSourceId = ::haxe::ui::toolkit::util::Identifier_obj::guid();
			HX_STACK_LINE(38)
...
::haxe::ui::toolkit::data::DataManager DataManager_obj::get_instance( ){
	...
	if (((::haxe::ui::toolkit::data::DataManager_obj::_instance == null()))){
		HX_STACK_LINE(11)
		::haxe::ui::toolkit::data::DataManager_obj::_instance = ::haxe::ui::toolkit::data::DataManager_obj::__new();
	}
	HX_STACK_LINE(13)
