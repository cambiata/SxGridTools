...
Dynamic ComponentItemRenderer_obj::set_data( Dynamic value){
	...
	if (((type != null()))){
		...
		HX_STACK_LINE(20)
		if (((  (((cls != null()))) ? bool((::Std_obj::is(this->_component,cls) == false)) : bool(false) ))){
			HX_STACK_LINE(21)
			...
			HX_STACK_LINE(24)
			this->_component = ::Type_obj::createInstance(cls,Dynamic( Array_obj<Dynamic>::__new()));
			HX_STACK_LINE(25)
...
::Class ComponentItemRenderer_obj::getClassFromType( ::String type){
	HX_STACK_FRAME("haxe.ui.toolkit.core.renderers.ComponentItemRenderer","getClassFromType",0x9370390c,"haxe.ui.toolkit.core.renderers.ComponentItemRenderer.getClassFromType","haxe/ui/toolkit/core/renderers/ComponentItemRenderer.hx",33,0x3c8dc337)
	HX_STACK_THIS(this)
