...
Void AsyncThreadCaller_obj::start( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(26)
		this->_startTime = ::flash::Lib_obj::getTimer();
		HX_STACK_LINE(27)
		::flash::Lib_obj::get_current()->get_stage()->addEventListener(::flash::events::Event_obj::ENTER_FRAME,this->run_dyn(),false,(int)100,null());
		HX_STACK_LINE(28)
		this->run(null());
	}
return null();
...
bool AsyncThreadCaller_obj::needToExit( ){
	...
	if ((!(this->_cancel))){
		HX_STACK_LINE(36)
		return (::flash::Lib_obj::getTimer() >= this->_workerExitTime);
	}
	else{
		HX_STACK_LINE(36)
		return true;
...
Void AsyncThreadCaller_obj::run( ::flash::events::Event event){
{
		...
		HX_STACK_LINE(40)
		Float frameRate = ::Math_obj::floor((Float((int)1000) / Float(::flash::Lib_obj::get_current()->get_stage()->frameRate)));		HX_STACK_VAR(frameRate,"frameRate");
		HX_STACK_LINE(41)
		int _g = ::flash::Lib_obj::getTimer();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(41)
		this->_workerExitTime = (_g + (frameRate * this->_runnableWorker->__Field(HX_CSTRING("get_runningTimeShare"),true)()));
		HX_STACK_LINE(43)
		...
		if (((this->_cancel == true))){
			HX_STACK_LINE(47)
			this->_endTime = ::flash::Lib_obj::getTimer();
			HX_STACK_LINE(48)
			this->dispose();
			HX_STACK_LINE(49)
			this->dispatchEvent(::flash::events::Event_obj::__new(::flash::events::Event_obj::CANCEL,null(),null()));
		}
		else{
			HX_STACK_LINE(50)
			if ((this->_runnableWorker->__Field(HX_CSTRING("get_isComplete"),true)())){
				HX_STACK_LINE(51)
				this->_data = this->_runnableWorker->__Field(HX_CSTRING("get_data"),true)();
				HX_STACK_LINE(52)
				this->_endTime = ::flash::Lib_obj::getTimer();
				HX_STACK_LINE(53)
				this->dispose();
				...
				HX_STACK_LINE(56)
				int _g1 = this->_runnableWorker->__Field(HX_CSTRING("get_progress"),true)();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(56)
				this->dispatchEvent(::flash::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,_g1,this->_runnableWorker->__Field(HX_CSTRING("get_total"),true)()));
			}
		}
	}
return null();
...
Void AsyncThreadCaller_obj::dispose( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(61)
		::flash::Lib_obj::get_current()->get_stage()->removeEventListener(::flash::events::Event_obj::ENTER_FRAME,this->run_dyn(),null());
		HX_STACK_LINE(62)
