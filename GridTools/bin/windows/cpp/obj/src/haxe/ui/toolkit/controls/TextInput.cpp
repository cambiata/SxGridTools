...
HX_STACK_FRAME("haxe.ui.toolkit.controls.TextInput","new",0xe9cabfb9,"haxe.ui.toolkit.controls.TextInput.new","haxe/ui/toolkit/controls/TextInput.hx",25,0x28010717)
{
	...
	HX_STACK_LINE(28)
	this->_layout = ::haxe::ui::toolkit::controls::TextInputLayout_obj::__new();
	HX_STACK_LINE(29)
	this->_textDisplay = ::haxe::ui::toolkit::text::TextDisplay_obj::__new();
	HX_STACK_LINE(30)
...
Void TextInput_obj::initialize( ){
{
		...
		HX_STACK_LINE(45)
		this->get_sprite()->addChild(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)());
		HX_STACK_LINE(47)
		if (((this->get_multiline() == true))){
			HX_STACK_LINE(48)
			this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("set_width"),true)(this->_layout->__Field(HX_CSTRING("get_innerWidth"),true)());
			HX_STACK_LINE(49)
			this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("set_height"),true)(this->_layout->__Field(HX_CSTRING("get_innerHeight"),true)());
		}
		HX_STACK_LINE(52)
		this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("addEventListener"),true)(::flash::events::Event_obj::CHANGE,this->_onTextChange_dyn(),null(),null(),null());
		HX_STACK_LINE(53)
		this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("addEventListener"),true)(::flash::events::Event_obj::SCROLL,this->_onTextScroll_dyn(),null(),null(),null());
		HX_STACK_LINE(54)
		this->checkScrolls();
		HX_STACK_LINE(56)
		if (((  (((this->_textPlaceHolder != null()))) ? bool((this->contains(this->_textPlaceHolder) == false)) : bool(false) ))){
			HX_STACK_LINE(57)
		...
		if (((this->_textPlaceHolder != null()))){
			...
			HX_STACK_LINE(64)
			this->_textPlaceHolder->set_textAlign(this->_textDisplay->__Field(HX_CSTRING("get_textAlign"),true)());
			HX_STACK_LINE(65)
...
Void TextInput_obj::dispose( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("removeEventListener"),true)(::flash::events::Event_obj::CHANGE,this->_onTextChange_dyn(),null());
		HX_STACK_LINE(71)
		this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("removeEventListener"),true)(::flash::events::Event_obj::SCROLL,this->_onTextScroll_dyn(),null());
		HX_STACK_LINE(72)
		this->get_sprite()->removeChild(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)());
		HX_STACK_LINE(73)
	...
	HX_STACK_ARG(recursive,"recursive")
{
		...
		if (((((int(type) & int((int)256))) == (int)256))){
			...
			this->checkScrolls();
			HX_STACK_LINE(88)
			this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("set_width"),true)(this->get_layout()->__Field(HX_CSTRING("get_innerWidth"),true)());
			HX_STACK_LINE(89)
			this->_textDisplay->__Field(HX_CSTRING("get_display"),true)()->__Field(HX_CSTRING("set_height"),true)(this->get_layout()->__Field(HX_CSTRING("get_innerHeight"),true)());
		}
		HX_STACK_LINE(91)
...
Void TextInput_obj::_onTextChange( ::flash::events::Event event){
{
...
Void TextInput_obj::_onTextScroll( ::flash::events::Event event){
{
...
Void TextInput_obj::_onVScrollChange( ::flash::events::Event event){
{
		...
		HX_STACK_LINE(122)
		tf->set_scrollV(::Std_obj::_int(this->_vscroll->get_pos()));
	}
return null();
}
...
Void TextInput_obj::_onHScrollChange( ::flash::events::Event event){
{
		...
		tf = hx::TCast< flash::text::TextField >::cast(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)());
		HX_STACK_LINE(129)
		tf->set_scrollH(::Std_obj::_int(this->_hscroll->get_pos()));
	}
return null();
}
...
Void TextInput_obj::applyStyle( ){
{
		...
		if (((this->_textDisplay != null()))){
			HX_STACK_LINE(155)
			this->_textDisplay->__Field(HX_CSTRING("set_style"),true)(this->get_style());
		}
	}
return null();
}
...
::flash::text::TextFormat TextInput_obj::get_selectedTextFormat( ){
	...
	tf = hx::TCast< flash::text::TextField >::cast(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)());
	HX_STACK_LINE(233)
	int _g = (this->get_selectionBeginIndex() - (int)1);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(233)
	return tf->getTextFormat(_g,this->get_selectionEndIndex());
}
...
::String TextInput_obj::set_placeholderText( ::String value){
	...
	if (((this->_textPlaceHolder == null()))){
		HX_STACK_LINE(263)
		this->_textPlaceHolder = ::haxe::ui::toolkit::controls::Text_obj::__new();
		HX_STACK_LINE(264)
	...
	HX_STACK_LINE(268)
	if (((  (((  ((this->_ready)) ? bool((this->contains(this->_textPlaceHolder) == false)) : bool(false) ))) ? bool((value != null())) : bool(false) ))){
		HX_STACK_LINE(269)
		this->addChild(this->_textPlaceHolder);
	}
	HX_STACK_LINE(271)
...
Void TextInput_obj::checkScrolls( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(367)
		if (((  ((!(((this->get_multiline() == false))))) ? bool((this->get_ready() == false)) : bool(true) ))){
			HX_STACK_LINE(368)
			return null();
		}
		HX_STACK_LINE(372)
		...
		tf = hx::TCast< flash::text::TextField >::cast(this->_textDisplay->__Field(HX_CSTRING("get_display"),true)());
		HX_STACK_LINE(373)
		int _g = tf->get_bottomScrollV();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(373)
		int visibleLines = ((_g - tf->get_scrollV()) + (int)1);		HX_STACK_VAR(visibleLines,"visibleLines");
		HX_STACK_LINE(374)
		if (((tf->get_maxScrollV() > (int)1))){
			HX_STACK_LINE(375)
			if (((this->_vscroll == null()))){
				HX_STACK_LINE(376)
			...
			HX_STACK_LINE(381)
			Float _g1 = (Float(visibleLines) / Float(tf->get_numLines()));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(381)
			this->_vscroll->set_pageSize((_g1 * ((tf->get_maxScrollV() - (int)1))));
			HX_STACK_LINE(382)
			this->_vscroll->set_min((int)1);
			HX_STACK_LINE(383)
			this->_vscroll->set_max(tf->get_maxScrollV());
			HX_STACK_LINE(384)
			this->_vscroll->set_incrementSize((int)1);
			HX_STACK_LINE(385)
			this->_vscroll->set_pos(tf->get_scrollV());
			HX_STACK_LINE(386)
		...
		if (((tf->get_maxScrollH() > (int)0))){
			...
			HX_STACK_LINE(401)
			Float _g2 = tf->get_width();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(401)
			Float _g3 = (_g2 - tf->get_maxScrollH());		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(401)
			Float _g4 = (Float(_g3) / Float(tf->get_width()));		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(401)
			this->_hscroll->set_pageSize((_g4 * tf->get_maxScrollH()));
			HX_STACK_LINE(402)
			this->_hscroll->set_min((int)0);
			HX_STACK_LINE(403)
			this->_hscroll->set_max(tf->get_maxScrollH());
			HX_STACK_LINE(404)
			this->_hscroll->set_pos(tf->get_scrollH());
			HX_STACK_LINE(405)
...
Dynamic TextInput_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 17:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"selectedTextFormat") ) { selectedTextFormat=inValue.Cast< ::flash::text::TextFormat >(); return inValue; }
		break;
	case 19:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::text::TextFormat*/ ,(int)offsetof(TextInput_obj,selectedTextFormat),HX_CSTRING("selectedTextFormat")},
