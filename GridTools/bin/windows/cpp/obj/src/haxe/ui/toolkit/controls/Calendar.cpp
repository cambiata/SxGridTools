...
HX_STACK_FRAME("haxe.ui.toolkit.controls.Calendar","new",0xe986f1c6,"haxe.ui.toolkit.controls.Calendar.new","haxe/ui/toolkit/controls/Calendar.hx",21,0xe933a32a)
{
	...
	super::__construct();
	HX_STACK_LINE(23)
	this->_layout = ::haxe::ui::toolkit::controls::CalendarLayout_obj::__new();
	HX_STACK_LINE(24)
	this->_autoSize = false;
	HX_STACK_LINE(25)
	this->_dayItems = Array_obj< ::Dynamic >::__new();
	HX_STACK_LINE(26)
	this->_selectedDate = ::Date_obj::now();
}
;
	return null();
}
			...
			while(((_g < (int)6))){
				...
				HX_STACK_LINE(36)
				{
					...
					while(((_g1 < (int)7))){
						...
						HX_STACK_LINE(38)
						dayItem->addEventListener(::flash::events::MouseEvent_obj::CLICK,this->buildMouseClickFunction(this->_dayItems->length),null(),null(),null());
						HX_STACK_LINE(39)
...
Void Calendar_obj::previousMonth( ){
{
		...
		HX_STACK_LINE(55)
		this->_day = hx::TCast< Int >::cast(::Math_obj::min(this->_day,this->getEndDay(this->_month,this->_year)));
		HX_STACK_LINE(56)
		this->set_date(::Date_obj::__new(this->_year,this->_month,this->_day,(int)0,(int)0,(int)0));
	}
return null();
}
...
::Date Calendar_obj::set_date( ::Date value){
	...
	HX_STACK_LINE(88)
	{
		...
		while(((_g < _g1->length))){
			HX_STACK_LINE(88)
			::haxe::ui::toolkit::controls::CalendarDay item = _g1->__get(_g).StaticCast< ::haxe::ui::toolkit::controls::CalendarDay >();		HX_STACK_VAR(item,"item");
			HX_STACK_LINE(88)
			++(_g);
			HX_STACK_LINE(89)
	...
	HX_STACK_LINE(93)
	{
		...
		while(((_g < endDay))){
			...
			HX_STACK_LINE(97)
			if (((  (((  ((((i + (int)1) == this->_selectedDate->getDate()))) ? bool((this->_month == this->_selectedDate->getMonth())) : bool(false) ))) ? bool((this->_year == this->_selectedDate->getFullYear())) : bool(false) ))){
				HX_STACK_LINE(98)
...
Void Calendar_obj::mouseClickButton( int index){
{
		...
		HX_STACK_LINE(141)
		int day = ::Std_obj::parseInt(item->get_text());		HX_STACK_VAR(day,"day");
		HX_STACK_LINE(142)
		this->set_selectedDate(::Date_obj::__new(this->_year,this->_month,day,(int)0,(int)0,(int)0));
		HX_STACK_LINE(143)
