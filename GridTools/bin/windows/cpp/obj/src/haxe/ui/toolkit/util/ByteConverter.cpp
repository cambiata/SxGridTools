...
::flash::utils::ByteArray ByteConverter_obj::fromHaxeBytes( ::haxe::io::Bytes bytes){
	...
	HX_STACK_LINE(8)
	::flash::utils::ByteArray ba = ::flash::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(ba,"ba");
	HX_STACK_LINE(9)
	{
		HX_STACK_LINE(9)
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(10)
			{
				...
				HX_STACK_LINE(10)
				ba->b[(ba->position)++] = bytes->b->__get(a);
			}
		}
	}
	HX_STACK_LINE(12)
