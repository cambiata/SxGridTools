...
::String Identifier_obj::createObjectId( Dynamic instance){
	HX_STACK_FRAME("haxe.ui.toolkit.util.Identifier","createObjectId",0xf79b4cb1,"haxe.ui.toolkit.util.Identifier.createObjectId","haxe/ui/toolkit/util/Identifier.hx",7,0x9ac865eb)
	HX_STACK_ARG(instance,"instance")
	HX_STACK_LINE(7)
	return ::haxe::ui::toolkit::util::Identifier_obj::createClassId(::Type_obj::getClass(instance));
}
...
::String Identifier_obj::createClassId( ::Class type){
	...
	HX_STACK_LINE(13)
	if (((::haxe::ui::toolkit::util::Identifier_obj::_objectCount->exists(className) == false))){
		HX_STACK_LINE(14)
...
::String Identifier_obj::guid( ){
	...
	HX_STACK_LINE(24)
	::String _g1 = ((_g + ::haxe::ui::toolkit::util::Identifier_obj::S4()) + HX_CSTRING("-"));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(24)
	::String _g2 = ((_g1 + ::haxe::ui::toolkit::util::Identifier_obj::S4()) + HX_CSTRING("-"));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(24)
	::String _g3 = ((_g2 + ::haxe::ui::toolkit::util::Identifier_obj::S4()) + HX_CSTRING("-"));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(24)
	::String _g4 = ((_g3 + ::haxe::ui::toolkit::util::Identifier_obj::S4()) + HX_CSTRING("-"));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(24)
	::String _g5 = (_g4 + ::haxe::ui::toolkit::util::Identifier_obj::S4());		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(24)
	::String _g6 = (_g5 + ::haxe::ui::toolkit::util::Identifier_obj::S4());		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(24)
	return (_g6 + ::haxe::ui::toolkit::util::Identifier_obj::S4());
}
...
::String Identifier_obj::S4( ){
	...
	HX_STACK_LINE(28)
	int n = (int(((((int)1 + ::Std_obj::random((int)65536))) * (int)65536)) | int((int)0));		HX_STACK_VAR(n,"n");
	HX_STACK_LINE(29)
