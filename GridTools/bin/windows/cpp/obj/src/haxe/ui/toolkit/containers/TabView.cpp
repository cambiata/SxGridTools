...
HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","new",0x19b9a312,"haxe.ui.toolkit.containers.TabView.new","haxe/ui/toolkit/containers/TabView.hx",15,0x54697f9e)
{
	...
	super::__construct();
	HX_STACK_LINE(17)
	this->_layout = ::haxe::ui::toolkit::layout::VerticalLayout_obj::__new();
	HX_STACK_LINE(19)
	this->_tabs = ::haxe::ui::toolkit::controls::TabBar_obj::__new();
	HX_STACK_LINE(20)
	this->_tabs->set_percentWidth((int)100);
	HX_STACK_LINE(21)
	this->_tabs->addEventListener(::flash::events::Event_obj::CHANGE,this->_onTabsChange_dyn(),null(),null(),null());
	HX_STACK_LINE(22)
	this->_tabs->addEventListener(HX_CSTRING("haxeui_glyphClick"),this->_onGlyphClick_dyn(),null(),null(),null());
	HX_STACK_LINE(23)
	this->addChild(this->_tabs);
	HX_STACK_LINE(25)
	this->_stack = ::haxe::ui::toolkit::containers::Stack_obj::__new();
	HX_STACK_LINE(26)
	this->_stack->set_percentWidth(this->_stack->set_percentHeight((int)100));
	HX_STACK_LINE(27)
...
Void TabView_obj::_onTabsChange( ::flash::events::Event event){
{
...
::haxe::ui::toolkit::core::interfaces::IDisplayObject TabView_obj::addChild( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child){
	...
	if (((bool((child == this->_tabs)) || bool((child == this->_stack))))){
		...
		if ((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::core::Component >()))){
			HX_STACK_LINE(64)
			label = (hx::TCast< haxe::ui::toolkit::core::Component >::cast(child))->get_text();
		}
		HX_STACK_LINE(67)
...
::haxe::ui::toolkit::core::interfaces::IDisplayObject TabView_obj::addChildAt( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child,int index){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","addChildAt",0x0222751c,"haxe.ui.toolkit.containers.TabView.addChildAt","haxe/ui/toolkit/containers/TabView.hx",72,0x54697f9e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
...
bool dispose = __o_dispose.Default(true);
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","removeChild",0x7e505b6a,"haxe.ui.toolkit.containers.TabView.removeChild","haxe/ui/toolkit/containers/TabView.hx",87,0x54697f9e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_ARG(dispose,"dispose")
{
		...
		if (((bool((child == this->_tabs)) || bool((child == this->_stack))))){
			...
			HX_STACK_LINE(92)
			r = this->_stack->removeChild(child,dispose);
		}
		HX_STACK_LINE(94)
		return r;
	}
...
int TabView_obj::get_selectedIndex( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","get_selectedIndex",0x9aece840,"haxe.ui.toolkit.containers.TabView.get_selectedIndex","haxe/ui/toolkit/containers/TabView.hx",104,0x54697f9e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
...
int TabView_obj::get_pageCount( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","get_pageCount",0x6a24d509,"haxe.ui.toolkit.containers.TabView.get_pageCount","haxe/ui/toolkit/containers/TabView.hx",113,0x54697f9e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(113)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","setTabText",0xcc3a8dae,"haxe.ui.toolkit.containers.TabView.setTabText","haxe/ui/toolkit/containers/TabView.hx",120,0x54697f9e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(index,"index")
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","removeTab",0x036f5ca3,"haxe.ui.toolkit.containers.TabView.removeTab","haxe/ui/toolkit/containers/TabView.hx",123,0x54697f9e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(index,"index")
		HX_STACK_LINE(124)
...
::haxe::ui::toolkit::controls::Button TabView_obj::getTabButton( int index){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","getTabButton",0x269b01bf,"haxe.ui.toolkit.containers.TabView.getTabButton","haxe/ui/toolkit/containers/TabView.hx",129,0x54697f9e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(129)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.TabView","removeAllTabs",0xe844bb8d,"haxe.ui.toolkit.containers.TabView.removeAllTabs","haxe/ui/toolkit/containers/TabView.hx",132,0x54697f9e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(133)
