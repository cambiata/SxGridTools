...
HX_STACK_FRAME("haxe.ui.toolkit.controls.Value","new",0x9c94480d,"haxe.ui.toolkit.controls.Value.new","haxe/ui/toolkit/controls/Value.hx",14,0xe74a4543)
{
	...
	HX_STACK_LINE(26)
	this->_values = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(27)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.controls.Value","addValue",0x4a833ac3,"haxe.ui.toolkit.controls.Value.addValue","haxe/ui/toolkit/controls/Value.hx",36,0xe74a4543)
		HX_STACK_THIS(this)
...
Void Value_obj::_onMouseClick( ::flash::events::MouseEvent event){
{
...
Dynamic Value_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.controls.Value","clone",0xcf72904a,"haxe.ui.toolkit.controls.Value.clone","haxe/ui/toolkit/core/Macros.hx",257,0x3fba9eca)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1)
