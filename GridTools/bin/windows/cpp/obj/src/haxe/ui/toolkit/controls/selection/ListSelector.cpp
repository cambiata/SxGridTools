...
Void ListSelector_obj::preInitialize( ){
{
		...
		if (((this->_style != null()))){
			HX_STACK_LINE(58)
			if (((this->_style->get_selectionMethod() != null()))){
				HX_STACK_LINE(59)
				this->_method = this->_style->get_selectionMethod();
			}
		}
	}
return null();
...
Void ListSelector_obj::_onMouseClick( ::flash::events::MouseEvent event){
{
		...
		HX_STACK_LINE(71)
		if (((  ((!(((this->_list == null()))))) ? bool((this->_list->get_visible() == false)) : bool(true) ))){
			HX_STACK_LINE(72)
			this->showList();
		}
		else{
...
Void ListSelector_obj::applyStyle( ){
{
		...
		if (((this->_style != null()))){
			HX_STACK_LINE(82)
			if (((  (((this->_style->get_selectionMethod() != null()))) ? bool((this->_method == null())) : bool(false) ))){
				HX_STACK_LINE(83)
				this->_method = this->_style->get_selectionMethod();
			}
		}
...
::haxe::ui::toolkit::data::IDataSource ListSelector_obj::get_dataSource( ){
	...
	if (((this->_dataSource == null()))){
		HX_STACK_LINE(98)
		this->_dataSource = ::haxe::ui::toolkit::data::ArrayDataSource_obj::__new();
	}
	HX_STACK_LINE(100)
...
Void ListSelector_obj::showList( ){
{
		...
		if (((this->_method == HX_CSTRING("popup")))){
			...
			if (((this->_list == null()))){
				HX_STACK_LINE(127)
				this->_list = ::haxe::ui::toolkit::containers::ListView_obj::__new();
				HX_STACK_LINE(128)
				...
				HX_STACK_LINE(129)
				this->_list->get_content()->addEventListener(::flash::events::Event_obj::ADDED_TO_STAGE, Dynamic(new _Function_3_1(_g)),null(),null(),null());
				HX_STACK_LINE(132)
			...
			HX_STACK_LINE(138)
			this->get_root()->addEventListener(::flash::events::MouseEvent_obj::MOUSE_WHEEL,this->_onRootMouseDown_dyn(),null(),null(),null());
			HX_STACK_LINE(140)
			Float _g1 = this->get_stageX();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(140)
			this->_list->set_x((_g1 - this->get_root()->get_stageX()));
			HX_STACK_LINE(141)
			Float _g2 = this->get_stageY();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(141)
			Float _g3 = (_g2 + this->get_height());		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(141)
			this->_list->set_y((_g3 - this->get_root()->get_stageY()));
			HX_STACK_LINE(142)
			if (((this->_list->get_width() == (int)0))){
				HX_STACK_LINE(143)
				this->_list->set_width(this->get_width());
			}
			HX_STACK_LINE(146)
			this->_list->get_sprite()->set_filters(Dynamic( Array_obj<Dynamic>::__new().Add(::flash::filters::DropShadowFilter_obj::__new((int)4,(int)45,(int)8421504,(int)1,(int)4,(int)4,(int)1,(int)3,null(),null(),null()))));
			HX_STACK_LINE(149)
			int n = this->_maxListSize;		HX_STACK_VAR(n,"n");
			HX_STACK_LINE(150)
			if (((n > this->_list->get_listSize()))){
				HX_STACK_LINE(151)
				n = this->_list->get_listSize();
			}
			HX_STACK_LINE(154)
			Float _g4 = (n * this->_list->get_itemHeight());		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(154)
			Float _g5 = this->_list->get_layout()->__Field(HX_CSTRING("get_padding"),true)()->__Field(HX_CSTRING("get_top"),true)();		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(154)
			Float listHeight = (_g4 + ((_g5 + this->_list->get_layout()->__Field(HX_CSTRING("get_padding"),true)()->__Field(HX_CSTRING("get_bottom"),true)())));		HX_STACK_VAR(listHeight,"listHeight");
			HX_STACK_LINE(155)
			...
			if (((transition == HX_CSTRING("slide")))){
				...
				HX_STACK_LINE(163)
				::motion::Actuate_obj::tween(this->_list,.1,_Function_3_1::Block(listHeight),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_3_2(_g)),null());
			}
			else{
				HX_STACK_LINE(166)
				if (((transition == HX_CSTRING("fade")))){
					...
					this->_list->set_visible(true);
					HX_STACK_LINE(169)
					::flash::display::Sprite _g6 = this->_list->get_sprite();		HX_STACK_VAR(_g6,"_g6");
					...
					HX_STACK_LINE(169)
					::motion::Actuate_obj::tween(_g6,.2,_Function_4_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_4_2()),null());
				}
				else{
					HX_STACK_LINE(172)
					this->_list->get_sprite()->set_alpha((int)1);
...
Void ListSelector_obj::hideList( ){
{
		...
		if (((this->_list != null()))){
			...
			if (((transition == HX_CSTRING("slide")))){
				...
				HX_STACK_LINE(188)
				::motion::Actuate_obj::tween(this->_list,.1,_Function_3_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_3_2(_g)),null());
			}
			else{
				HX_STACK_LINE(192)
				if (((transition == HX_CSTRING("fade")))){
					HX_STACK_LINE(193)
					::flash::display::Sprite _g1 = this->_list->get_sprite();		HX_STACK_VAR(_g1,"_g1");
					struct _Function_4_1{
						inline static Dynamic Block( ){
					...
					HX_STACK_LINE(193)
					::motion::Actuate_obj::tween(_g1,.2,_Function_4_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onComplete( Dynamic(new _Function_4_2(_g)),null());
				}
				else{
					HX_STACK_LINE(197)
					this->_list->get_sprite()->set_alpha((int)1);
...
Void ListSelector_obj::_onRootMouseDown( ::flash::events::MouseEvent event){
{
		...
		if (((this->_list != null()))){
			HX_STACK_LINE(270)
			mouseInList = this->_list->hitTest(event->stageX,event->stageY);
		}
		HX_STACK_LINE(273)
		...
		if (((bool((bool((mouseInList == false)) && bool((this->_list != null())))) && bool((mouseIn == false))))){
			...
			HX_STACK_LINE(276)
			this->get_root()->removeEventListener(::flash::events::MouseEvent_obj::MOUSE_WHEEL,this->_onRootMouseDown_dyn(),null());
			HX_STACK_LINE(277)
			this->hideList();
		}
	}
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.controls.selection.ListSelector","_onListChange",0xb6a6e0b3,"haxe.ui.toolkit.controls.selection.ListSelector._onListChange","haxe/ui/toolkit/controls/selection/ListSelector.hx",282,0x5c9ca828)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(282)
		if (((  (((this->_list->get_selectedItems() != null()))) ? bool((this->_list->get_selectedItems()->length > (int)0)) : bool(false) ))){
			HX_STACK_LINE(283)
