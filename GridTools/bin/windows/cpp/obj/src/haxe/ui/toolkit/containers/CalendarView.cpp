...
HX_STACK_FRAME("haxe.ui.toolkit.containers.CalendarView","new",0xe0ef7f2f,"haxe.ui.toolkit.containers.CalendarView.new","haxe/ui/toolkit/containers/CalendarView.hx",19,0x9c504021)
{
	...
	super::__construct();
	HX_STACK_LINE(21)
	this->_calendar = ::haxe::ui::toolkit::controls::Calendar_obj::__new();
	HX_STACK_LINE(22)
...
Void CalendarView_obj::initialize( ){
{
		...
		HX_STACK_LINE(35)
		this->_prevMonthButton = ::haxe::ui::toolkit::controls::Button_obj::__new();
		HX_STACK_LINE(36)
		this->_prevMonthButton->set_text(HX_CSTRING("<"));
		HX_STACK_LINE(37)
		this->_prevMonthButton->addEventListener(::flash::events::MouseEvent_obj::CLICK,this->_onPrevClicked_dyn(),null(),null(),null());
		HX_STACK_LINE(38)
		...
		HX_STACK_LINE(45)
		this->_currentMonthYear = ::haxe::ui::toolkit::controls::Text_obj::__new();
		HX_STACK_LINE(46)
		...
		HX_STACK_LINE(62)
		this->_nextMonthButton = ::haxe::ui::toolkit::controls::Button_obj::__new();
		HX_STACK_LINE(63)
		this->_nextMonthButton->set_text(HX_CSTRING(">"));
		HX_STACK_LINE(64)
		this->_nextMonthButton->addEventListener(::flash::events::MouseEvent_obj::CLICK,this->_onNextClicked_dyn(),null(),null(),null());
		HX_STACK_LINE(65)
		hbox->addChild(this->_nextMonthButton);
		HX_STACK_LINE(67)
		this->addChild(hbox);
		HX_STACK_LINE(69)
		this->_calendar->addEventListener(::flash::events::Event_obj::CHANGE,this->_onDateChanged_dyn(),null(),null(),null());
		HX_STACK_LINE(70)
...
Void CalendarView_obj::_onPrevClicked( ::flash::events::MouseEvent event){
{
...
Void CalendarView_obj::_onNextClicked( ::flash::events::MouseEvent event){
{
...
Void CalendarView_obj::_onDateChanged( ::flash::events::Event event){
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.CalendarView","_onDateChanged",0x5a4e8759,"haxe.ui.toolkit.containers.CalendarView._onDateChanged","haxe/ui/toolkit/containers/CalendarView.hx",112,0x9c504021)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(112)
...
Void CalendarView_obj::displayMonthYear( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		::String monthName = ::haxe::ui::toolkit::containers::CalendarView_obj::MONTH_NAMES->__get(this->_calendar->get_date()->getMonth());		HX_STACK_VAR(monthName,"monthName");
		HX_STACK_LINE(120)
		this->_currentMonthYear->set_text(((monthName + HX_CSTRING(" ")) + this->_calendar->get_date()->getFullYear()));
	}
return null();
}
