...
::flash::filters::BitmapFilter FilterParser_obj::parseFilter( ::String filterString){
	...
	HX_STACK_LINE(19)
	::flash::filters::BitmapFilter filter = null();		HX_STACK_VAR(filter,"filter");
	HX_STACK_LINE(20)
	...
	if (((bool((n1 != (int)-1)) && bool((n2 != (int)-1))))){
		HX_STACK_LINE(26)
		filterName = filterString.substr((int)0,n1);
		HX_STACK_LINE(27)
		filterParams = filterString.substr((n1 + (int)1),((n2 - n1) - (int)1));
	}
	else{
		HX_STACK_LINE(29)
	...
	if (((filterName != null()))){
		HX_STACK_LINE(33)
		filterName = ::StringTools_obj::trim(filterName);
		HX_STACK_LINE(34)
		filter = ::haxe::ui::toolkit::util::FilterParser_obj::createFilter(filterName,filterParams);
	}
	HX_STACK_LINE(37)
	return filter;
}
...
::flash::filters::BitmapFilter FilterParser_obj::createFilter( ::String filterName,::String filterParams){
	...
	if (((filterParams != null()))){
		HX_STACK_LINE(45)
		params = filterParams.split(HX_CSTRING(","));
	}
	HX_STACK_LINE(48)
	params = ::haxe::ui::toolkit::util::FilterParser_obj::copyFilterDefaults(filterName,params);
	HX_STACK_LINE(50)
	if (((filterName == HX_CSTRING("blur")))){
		HX_STACK_LINE(51)
		filter = ::haxe::ui::toolkit::util::FilterParser_obj::createBlurFilter(params);
	}
	else{
		HX_STACK_LINE(52)
		if (((filterName == HX_CSTRING("dropShadow")))){
			HX_STACK_LINE(53)
			filter = ::haxe::ui::toolkit::util::FilterParser_obj::createDropShadowFilter(params);
		}
		else{
			HX_STACK_LINE(54)
			if (((filterName == HX_CSTRING("glow")))){
				HX_STACK_LINE(55)
				filter = ::haxe::ui::toolkit::util::FilterParser_obj::createGlowFilter(params);
			}
		}
	}
	HX_STACK_LINE(58)
...
::flash::filters::BlurFilter FilterParser_obj::createBlurFilter( Array< ::String > params){
	...
	HX_STACK_LINE(63)
	::flash::filters::BlurFilter filter = ::flash::filters::BlurFilter_obj::__new(_g,_g1,::haxe::ui::toolkit::util::TypeParser_obj::parseInt(params->__get((int)2)));		HX_STACK_VAR(filter,"filter");
	HX_STACK_LINE(68)
	return filter;
}
...
::flash::filters::DropShadowFilter FilterParser_obj::createDropShadowFilter( Array< ::String > params){
	...
	HX_STACK_LINE(73)
	::flash::filters::DropShadowFilter filter = ::flash::filters::DropShadowFilter_obj::__new(_g,_g1,_g2,_g3,_g4,_g5,_g6,_g7,_g8,_g9,::haxe::ui::toolkit::util::TypeParser_obj::parseBool(params->__get((int)10)));		HX_STACK_VAR(filter,"filter");
	HX_STACK_LINE(86)
	return filter;
}
...
::flash::filters::GlowFilter FilterParser_obj::createGlowFilter( Array< ::String > params){
	...
	HX_STACK_LINE(91)
	::flash::filters::GlowFilter filter = ::flash::filters::GlowFilter_obj::__new(_g,_g1,_g2,_g3,_g4,_g5,_g6,::haxe::ui::toolkit::util::TypeParser_obj::parseBool(params->__get((int)7)));		HX_STACK_VAR(filter,"filter");
	HX_STACK_LINE(101)
	return filter;
}
...
struct _Function_0_1{
	inline static Dynamic Block( ){
		...
		{
			HX_STACK_LINE(10)
			Array< ::String > _g = Array_obj< ::String >::__new().Add(HX_CSTRING("4")).Add(HX_CSTRING("4")).Add(HX_CSTRING("1"));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(11)
			Array< ::String > _g1 = Array_obj< ::String >::__new().Add(HX_CSTRING("4")).Add(HX_CSTRING("45")).Add(HX_CSTRING("0")).Add(HX_CSTRING("1")).Add(HX_CSTRING("4")).Add(HX_CSTRING("4")).Add(HX_CSTRING("1")).Add(HX_CSTRING("1")).Add(HX_CSTRING("false")).Add(HX_CSTRING("false")).Add(HX_CSTRING("false"));		HX_STACK_VAR(_g1,"_g1");
			struct _Function_1_1{
				inline static Dynamic Block( Array< ::String > &_g1,Array< ::String > &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ui/toolkit/util/FilterParser.hx",9,0x2af1b1dd)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("blur") , _g,false);
						__result->Add(HX_CSTRING("dropShadow") , _g1,false);
