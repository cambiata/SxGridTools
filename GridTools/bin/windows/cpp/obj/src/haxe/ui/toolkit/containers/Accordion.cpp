...
::haxe::ui::toolkit::core::interfaces::IDisplayObject Accordion_obj::addChild( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child){
	...
	if ((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::containers::AccordionButton >()))){
		...
		if ((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::core::Component >()))){
			HX_STACK_LINE(69)
			button->set_text((hx::TCast< haxe::ui::toolkit::core::Component >::cast(child))->get_text());
		}
		HX_STACK_LINE(71)
...
Void Accordion_obj::_onButtonClick( ::haxe::ui::toolkit::events::UIEvent event){
{
		...
		HX_STACK_LINE(139)
		this->dispatchEvent(::haxe::ui::toolkit::events::UIEvent_obj::__new(HX_CSTRING("haxeui_change"),null(),null(),null()));
	}
return null();
}
...
Void Accordion_obj::showPanel( int index){
{
		...
		if (((transition == HX_CSTRING("slide")))){
			...
			HX_STACK_LINE(162)
			::motion::Actuate_obj::tween(panel,.2,_Function_2_1::Block(ucy),true,null())->ease(::motion::easing::Linear_obj::get_easeNone())->onUpdate(this->_onTweenUpdate_dyn(),Dynamic( Array_obj<Dynamic>::__new().Add(ucy).Add(panel).Add(panelOld)))->onComplete(this->_onTweenComplete_dyn(),Dynamic( Array_obj<Dynamic>::__new().Add(panel).Add(panelOld).Add(buttonOld)));
		}
		else{
			HX_STACK_LINE(165)
			if (((transition == HX_CSTRING("fade")))){
				...
				HX_STACK_LINE(172)
				::flash::display::Sprite _g = panel->get_sprite();		HX_STACK_VAR(_g,"_g");
				...
				HX_STACK_LINE(172)
				::motion::Actuate_obj::tween(_g,.2,_Function_3_1::Block(),true,null())->ease(::motion::easing::Linear_obj::get_easeNone());
			}
			else{
				HX_STACK_LINE(174)
				panel->set_visible(true);
...
Dynamic Accordion_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.Accordion","clone",0x4a534dbd,"haxe.ui.toolkit.containers.Accordion.clone","haxe/ui/toolkit/core/Macros.hx",257,0x3fba9eca)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1)
	...
	HX_STACK_LINE(216)
	{
		...
		while(((_g < _g1->length))){
			...
			++(_g);
			HX_STACK_LINE(217)
			if (((::Std_obj::is(child,hx::ClassOf< ::haxe::ui::toolkit::containers::AccordionButton >()) == false))){
				HX_STACK_LINE(218)
