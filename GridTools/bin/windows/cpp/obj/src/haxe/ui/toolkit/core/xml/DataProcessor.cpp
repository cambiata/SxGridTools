...
Dynamic DataProcessor_obj::process( ::Xml node){
	...
	HX_STACK_LINE(14)
	::String nodeName = this->stripNamespace(node->get_nodeName());		HX_STACK_VAR(nodeName,"nodeName");
	HX_STACK_LINE(15)
	...
	if (((className != null()))){
		HX_STACK_LINE(19)
		result = ::haxe::ui::toolkit::core::xml::DataProcessor_obj::createDataSource(className,node);
	}
	HX_STACK_LINE(21)
	return result;
}
