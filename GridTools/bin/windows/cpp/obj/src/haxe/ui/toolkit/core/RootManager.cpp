...
{
HX_STACK_FRAME("haxe.ui.toolkit.core.RootManager","new",0x3fbd8d70,"haxe.ui.toolkit.core.RootManager.new","haxe/ui/toolkit/core/RootManager.hx",23,0xcb4d01c0)
{
	HX_STACK_LINE(23)
...
::haxe::ui::toolkit::core::Root RootManager_obj::createRoot( Dynamic options,Dynamic fn){
	...
	if (((options->__Field(HX_CSTRING("parent"),true) != null()))){
		HX_STACK_LINE(31)
		options->__FieldRef(HX_CSTRING("parent")) = options->__Field(HX_CSTRING("parent"),true);
	}
	else{
		HX_STACK_LINE(31)
		options->__FieldRef(HX_CSTRING("parent")) = ::flash::Lib_obj::get_current()->get_stage();
	}
	HX_STACK_LINE(33)
	...
	Void run(Dynamic e){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","haxe/ui/toolkit/core/RootManager.hx",34,0xcb4d01c0)
		HX_STACK_ARG(e,"e")
		{
			HX_STACK_LINE(35)
			...
			HX_STACK_LINE(42)
			root->__get((int)0).StaticCast< ::haxe::ui::toolkit::core::Root >()->removeEventListenerType(::flash::events::Event_obj::ADDED_TO_STAGE);
		}
		return null();
	}
	...
	HX_STACK_LINE(34)
	root->__get((int)0).StaticCast< ::haxe::ui::toolkit::core::Root >()->addEventListener(::flash::events::Event_obj::ADDED_TO_STAGE, Dynamic(new _Function_1_1(fn1,root)),null(),null(),null());
	HX_STACK_LINE(45)
	...
	HX_STACK_LINE(54)
	options->__Field(HX_CSTRING("parent"),true)->__Field(HX_CSTRING("addChild"),true)(root->__get((int)0).StaticCast< ::haxe::ui::toolkit::core::Root >()->get_sprite());
	HX_STACK_LINE(55)
...
Void RootManager_obj::destroyRoot( ::haxe::ui::toolkit::core::Root root){
{
		...
		HX_STACK_LINE(60)
		if (((root->get_sprite()->get_parent() != null()))){
			HX_STACK_LINE(61)
			root->get_sprite()->get_parent()->removeChild(root->get_sprite());
		}
		HX_STACK_LINE(62)
		root->dispose();
		HX_STACK_LINE(64)
...
::haxe::ui::toolkit::core::RootManager RootManager_obj::get_instance( ){
	...
	if (((::haxe::ui::toolkit::core::RootManager_obj::_instance == null()))){
		HX_STACK_LINE(12)
		::haxe::ui::toolkit::core::RootManager_obj::_instance = ::haxe::ui::toolkit::core::RootManager_obj::__new();
	}
	HX_STACK_LINE(14)
