...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",37,0xcbd4592a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_FRAME("haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",46,0xcbd4592a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",67,0xcbd4592a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.io.Input","readFullBytes",0x3db9a162,"haxe.io.Input.readFullBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",100,0xcbd4592a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(pos,"pos")
		HX_STACK_ARG(len,"len")
...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",127,0xcbd4592a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
...
::String Input_obj::readString( int len){
	HX_STACK_FRAME("haxe.io.Input","readString",0xfdebd00b,"haxe.io.Input.readString","F:\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",326,0xcbd4592a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(327)
