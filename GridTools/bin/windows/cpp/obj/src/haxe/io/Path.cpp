...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x7d56f2c3)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",141,0x7d56f2c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(142)
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",268,0x7d56f2c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(269)
...
::String Path_obj::removeTrailingSlashes( ::String path){
	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",293,0x7d56f2c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(294)
	while((true)){
		HX_STACK_LINE(295)
