...
{
HX_STACK_FRAME("haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesInput.hx",38,0xf2470c89)
...
int BytesInput_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesInput.hx",87,0xf2470c89)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
	if (((this->len == (int)0))){
		HX_STACK_LINE(92)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesInput.hx",108,0xf2470c89)
	HX_STACK_THIS(this)
