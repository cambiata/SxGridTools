...
{
HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","new",0xda5f4ac8,"haxe.ds.GenericStack_hscript_Token.new","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",67,0xdd3fade0)
{
}
;
	return null();
...
{
		HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","add",0xda556c89,"haxe.ds.GenericStack_hscript_Token.add","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",74,0xdd3fade0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(74)
		this->head = ::haxe::ds::GenericCell_hscript_Token_obj::__new(item,this->head);
	}
return null();
}
...
::hscript::Token GenericStack_hscript_Token_obj::first( ){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","first",0x104a5c98,"haxe.ds.GenericStack_hscript_Token.first","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",83,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(83)
	if (((this->head == null()))){
		HX_STACK_LINE(83)
...
::hscript::Token GenericStack_hscript_Token_obj::pop( ){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","pop",0xda60d7f9,"haxe.ds.GenericStack_hscript_Token.pop","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",91,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(92)
...
bool GenericStack_hscript_Token_obj::isEmpty( ){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","isEmpty",0x0c5cacab,"haxe.ds.GenericStack_hscript_Token.isEmpty","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",105,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(105)
...
bool GenericStack_hscript_Token_obj::remove( ::hscript::Token v){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","remove",0xac2392dc,"haxe.ds.GenericStack_hscript_Token.remove","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",117,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(118)
...
Dynamic GenericStack_hscript_Token_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","iterator",0x90d21686,"haxe.ds.GenericStack_hscript_Token.iterator","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",140,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(140)
...
::String GenericStack_hscript_Token_obj::toString( ){
	HX_STACK_FRAME("haxe.ds.GenericStack_hscript_Token","toString",0x35a69d44,"haxe.ds.GenericStack_hscript_Token.toString","F:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",166,0xdd3fade0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(167)
