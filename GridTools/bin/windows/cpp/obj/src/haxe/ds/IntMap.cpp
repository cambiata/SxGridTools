...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",29,0xaaecc0d1)
{
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",33,0xaaecc0d1)
		HX_STACK_THIS(this)
...
Dynamic IntMap_obj::get( Dynamic _tmp_key){
	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",37,0xaaecc0d1)
	HX_STACK_THIS(this)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",41,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
...
bool IntMap_obj::remove( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",45,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(45)
...
Dynamic IntMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",48,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
...
Dynamic IntMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.IntMap","iterator",0x4dc7ddd8,"haxe.ds.IntMap.iterator","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",53,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
