...
{
		HX_STACK_FRAME("Sys","print",0x483745ec,"Sys.print","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",25,0x85f8069a)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(25)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_FRAME("Sys","println",0x3905f76e,"Sys.println","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",28,0x85f8069a)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(29)
		::Sys_obj::print(v);
		HX_STACK_LINE(30)
...
::haxe::io::Output Sys_obj::_stderr( ){
	HX_STACK_FRAME("Sys","stderr",0x3eb04003,"Sys.stderr","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",42,0x85f8069a)
	HX_STACK_LINE(42)
...
{
		HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",65,0x85f8069a)
...
::String Sys_obj::getCwd( ){
	HX_STACK_FRAME("Sys","getCwd",0xd9ded99b,"Sys.getCwd","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",73,0x85f8069a)
	HX_STACK_LINE(73)
...
{
		HX_STACK_FRAME("Sys","setCwd",0xa6272e0f,"Sys.setCwd","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",77,0x85f8069a)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(77)
		::Sys_obj::set_cwd(s);
	}
...
::String Sys_obj::escapeArgument( ::String arg){
	HX_STACK_FRAME("Sys","escapeArgument",0xb9d4397f,"Sys.escapeArgument","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",84,0x85f8069a)
...
int Sys_obj::command( ::String cmd,Array< ::String > args){
	HX_STACK_FRAME("Sys","command",0x363f8cca,"Sys.command","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",98,0x85f8069a)
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",108,0x85f8069a)
...
::String Sys_obj::executablePath( ){
	HX_STACK_FRAME("Sys","executablePath",0xfc9406f0,"Sys.executablePath","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",120,0x85f8069a)
	HX_STACK_LINE(120)
