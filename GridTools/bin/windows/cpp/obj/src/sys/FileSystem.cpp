...
{
		HX_STACK_FRAME("sys.FileSystem","rename",0x3aa2fb40,"sys.FileSystem.rename","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0x01a6fd28)
...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0x01a6fd28)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(43)
	...
	if (((s == null()))){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &_g1,::Date &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0x01a6fd28)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",53,0x01a6fd28)
...
::sys::_FileSystem::FileKind FileSystem_obj::kind( ::String path){
	HX_STACK_FRAME("sys.FileSystem","kind",0xa0dedc96,"sys.FileSystem.kind","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",56,0x01a6fd28)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(57)
	::String k = ::sys::FileSystem_obj::sys_file_type(::haxe::io::Path_obj::removeTrailingSlashes(path));		HX_STACK_VAR(k,"k");
	HX_STACK_LINE(58)
	::String _switch_1 = (k);
...
bool FileSystem_obj::isDirectory( ::String path){
	HX_STACK_FRAME("sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",66,0x01a6fd28)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(66)
...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",69,0x01a6fd28)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(70)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",80,0x01a6fd28)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",85,0x01a6fd28)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(85)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	HX_STACK_FRAME("sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",90,0x01a6fd28)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(90)
