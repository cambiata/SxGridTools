...
{
HX_STACK_FRAME("sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",31,0x0dcea22e)
...
int FileInput_obj::readByte( ){
	HX_STACK_FRAME("sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",35,0x0dcea22e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
	try
	{
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_FRAME("sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",46,0x0dcea22e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(l,"l")
...
{
		HX_STACK_FRAME("sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",56,0x0dcea22e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(57)
		this->super::close();
		HX_STACK_LINE(58)
