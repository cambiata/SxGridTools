...
::String File_obj::getContent( ::String path){
	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",27,0x44c493e4)
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",32,0x44c493e4)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","read",0x203d07e1,"sys.io.File.read","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",50,0x44c493e4)
	HX_STACK_ARG(path,"path")
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","write",0xfec8a9f4,"sys.io.File.write","F:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",54,0x44c493e4)
	HX_STACK_ARG(path,"path")
	HX_STACK_ARG(binary,"binary")
{
		HX_STACK_LINE(54)
