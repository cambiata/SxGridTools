...
Dynamic Lambda_obj::array( Dynamic it){
	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","F:\\HaxeToolkit\\haxe\\std/Lambda.hx",42,0xb8ba1b01)
	HX_STACK_ARG(it,"it")
	HX_STACK_LINE(43)
...
bool Lambda_obj::has( Dynamic it,Dynamic elt){
	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","F:\\HaxeToolkit\\haxe\\std/Lambda.hx",98,0xb8ba1b01)
	HX_STACK_ARG(it,"it")
...
int Lambda_obj::indexOf( Dynamic it,Dynamic v){
	HX_STACK_FRAME("Lambda","indexOf",0xbf6a7082,"Lambda.indexOf","F:\\HaxeToolkit\\haxe\\std/Lambda.hx",217,0xb8ba1b01)
	HX_STACK_ARG(it,"it")
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(218)
