...
{
HX_STACK_FRAME("openfl.AssetCache","new",0x4c82a362,"openfl.AssetCache.new","openfl/Assets.hx",1294,0x989d477c)
{
	HX_STACK_LINE(1298)
	this->enabled = true;
	HX_STACK_LINE(1305)
...
{
		HX_STACK_FRAME("openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",1312,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1314)
		this->bitmapData = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(1315)
