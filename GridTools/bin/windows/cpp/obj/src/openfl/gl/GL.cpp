...
Void GL_obj::bufferData( int target,::openfl::utils::IMemoryRange data,int usage){
{
		...
		HX_STACK_LINE(501)
		::openfl::gl::GL_obj::lime_gl_buffer_data(target,_g,_g1,data->getLength(),usage);
	}
return null();
}
...
Void GL_obj::bufferSubData( int target,int offset,::openfl::utils::IMemoryRange data){
{
		...
		int _g1 = data->getStart();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(506)
		::openfl::gl::GL_obj::lime_gl_buffer_sub_data(target,offset,_g,_g1,data->getLength());
	}
return null();
}
...
Void GL_obj::compressedTexImage2D( int target,int level,int internalformat,int width,int height,int border,::openfl::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(546)
		::openfl::gl::GL_obj::lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,_g,(  (((data == null()))) ? Dynamic(null()) : Dynamic(data->getStart()) ));
	}
return null();
}
...
Void GL_obj::compressedTexSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,::openfl::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(551)
		::openfl::gl::GL_obj::lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,_g,(  (((data == null()))) ? Dynamic(null()) : Dynamic(data->getStart()) ));
	}
return null();
}
...
::openfl::gl::GLBuffer GL_obj::createBuffer( ){
	...
	HX_STACK_LINE(566)
	return ::openfl::gl::GLBuffer_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_buffer());
}
...
::openfl::gl::GLFramebuffer GL_obj::createFramebuffer( ){
	...
	int _g = ::openfl::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(571)
	return ::openfl::gl::GLFramebuffer_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_framebuffer());
}
...
::openfl::gl::GLProgram GL_obj::createProgram( ){
	...
	int _g = ::openfl::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(576)
	return ::openfl::gl::GLProgram_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_program());
}
...
::openfl::gl::GLRenderbuffer GL_obj::createRenderbuffer( ){
	...
	int _g = ::openfl::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(581)
	return ::openfl::gl::GLRenderbuffer_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_render_buffer());
}
...
::openfl::gl::GLShader GL_obj::createShader( int type){
	...
	int _g = ::openfl::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(586)
	return ::openfl::gl::GLShader_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_shader(type));
}
...
::openfl::gl::GLTexture GL_obj::createTexture( ){
	...
	int _g = ::openfl::gl::GL_obj::get_version();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(591)
	return ::openfl::gl::GLTexture_obj::__new(_g,::openfl::gl::GL_obj::lime_gl_create_texture());
}
...
Void GL_obj::readPixels( int x,int y,int width,int height,int format,int type,::flash::utils::ByteArray pixels){
{
		...
		HX_STACK_LINE(913)
		::openfl::gl::GL_obj::lime_gl_read_pixels(x,y,width,height,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->getStart()) ));
	}
return null();
}
...
Void GL_obj::texImage2D( int target,int level,int internalformat,int width,int height,int border,int format,int type,::openfl::utils::ArrayBufferView pixels){
{
		...
		HX_STACK_LINE(968)
		::openfl::gl::GL_obj::lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->getStart()) ));
	}
return null();
}
...
Void GL_obj::texSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,int type,::openfl::utils::ArrayBufferView pixels){
{
		...
		HX_STACK_LINE(983)
		::openfl::gl::GL_obj::lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->getStart()) ));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl.gl.GL","uniformMatrix3D",0xf11ac388,"openfl.gl.GL.uniformMatrix3D","openfl/gl/GL.hx",1099,0x296f94ae)
		HX_STACK_ARG(location,"location")
		HX_STACK_ARG(transpose,"transpose")
		HX_STACK_ARG(matrix,"matrix")
		struct _Function_1_1{
			inline static Dynamic Block( ::flash::geom::Matrix3D &matrix){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/gl/GL.hx",1099,0x296f94ae)
				{
					HX_STACK_LINE(1099)
		...
		HX_STACK_LINE(1099)
		::openfl::gl::GL_obj::lime_gl_uniform_matrix(location,transpose,_Function_1_1::Block(matrix),(int)4);
	}
return null();
}
