...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Jonas Nystr\xc3""\xb6""m"),HX_CSTRING("GridTools"),HX_CSTRING("sx.GridTools"),HX_CSTRING("1.0.0"));
		HX_STACK_LINE(113)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",35,0x0780ded5)
			{
				...
				HX_STACK_LINE(81)
				{
					...
					HX_STACK_LINE(81)
					Array< ::String > _g12 = ::Type_obj::getClassFields(hx::ClassOf< ::sx::Main >());		HX_STACK_VAR(_g12,"_g12");
					HX_STACK_LINE(81)
				...
				if ((hasMain)){
					HX_STACK_LINE(94)
					Dynamic _g11 = ::Reflect_obj::field(hx::ClassOf< ::sx::Main >(),HX_CSTRING("main"));		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(94)
					::Reflect_obj::callMethod(hx::ClassOf< ::sx::Main >(),_g11,Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(98)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("GridTools"),null(),null());
	}
return null();
}
