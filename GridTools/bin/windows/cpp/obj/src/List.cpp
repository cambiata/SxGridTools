...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","F:\\HaxeToolkit\\haxe\\std/List.hx",41,0x0ac4738a)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
}
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","F:\\HaxeToolkit\\haxe\\std/List.hx",49,0x0ac4738a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("List","push",0xebb5efca,"List.push","F:\\HaxeToolkit\\haxe\\std/List.hx",64,0x0ac4738a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(68)
...
Dynamic List_obj::first( ){
	HX_STACK_FRAME("List","first",0x898acc40,"List.first","F:\\HaxeToolkit\\haxe\\std/List.hx",82,0x0ac4738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	if (((this->h == null()))){
		HX_STACK_LINE(82)
...
Dynamic List_obj::pop( ){
	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","F:\\HaxeToolkit\\haxe\\std/List.hx",100,0x0ac4738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
	if (((this->h == null()))){
		HX_STACK_LINE(102)
...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","F:\\HaxeToolkit\\haxe\\std/List.hx",115,0x0ac4738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	return (this->h == null());
}
...
Void List_obj::clear( ){
{
		HX_STACK_FRAME("List","clear",0xd148c59d,"List.clear","F:\\HaxeToolkit\\haxe\\std/List.hx",124,0x0ac4738a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(125)
		this->h = null();
		HX_STACK_LINE(126)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","F:\\HaxeToolkit\\haxe\\std/List.hx",138,0x0ac4738a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
...
Dynamic List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","F:\\HaxeToolkit\\haxe\\std/List.hx",179,0x0ac4738a)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/List.hx",179,0x0ac4738a)
			{
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","F:\\HaxeToolkit\\haxe\\std/List.hx",182,0x0ac4738a)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","F:\\HaxeToolkit\\haxe\\std/List.hx",185,0x0ac4738a)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(186)
