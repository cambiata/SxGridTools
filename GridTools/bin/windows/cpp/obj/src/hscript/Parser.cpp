...
HX_STACK_FRAME("hscript.Parser","new",0x4b9f158c,"hscript.Parser.new","hscript/Parser.hx",99,0x98735743)
{
	...
	HX_STACK_LINE(104)
	Array< ::String > _g = Array_obj< ::String >::__new().Add(HX_CSTRING("%"));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(105)
	Array< ::String > _g1 = Array_obj< ::String >::__new().Add(HX_CSTRING("*")).Add(HX_CSTRING("/"));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(106)
	Array< ::String > _g2 = Array_obj< ::String >::__new().Add(HX_CSTRING("+")).Add(HX_CSTRING("-"));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(107)
	Array< ::String > _g3 = Array_obj< ::String >::__new().Add(HX_CSTRING("<<")).Add(HX_CSTRING(">>")).Add(HX_CSTRING(">>>"));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(108)
	Array< ::String > _g4 = Array_obj< ::String >::__new().Add(HX_CSTRING("|")).Add(HX_CSTRING("&")).Add(HX_CSTRING("^"));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(109)
	Array< ::String > _g5 = Array_obj< ::String >::__new().Add(HX_CSTRING("==")).Add(HX_CSTRING("!=")).Add(HX_CSTRING(">")).Add(HX_CSTRING("<")).Add(HX_CSTRING(">=")).Add(HX_CSTRING("<="));		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(110)
	Array< ::String > _g6 = Array_obj< ::String >::__new().Add(HX_CSTRING("..."));		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(111)
	Array< ::String > _g7 = Array_obj< ::String >::__new().Add(HX_CSTRING("&&"));		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(112)
	Array< ::String > _g8 = Array_obj< ::String >::__new().Add(HX_CSTRING("||"));		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(103)
	Array< ::Dynamic > priorities = Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_g2).Add(_g3).Add(_g4).Add(_g5).Add(_g6).Add(_g7).Add(_g8).Add(Array_obj< ::String >::__new().Add(HX_CSTRING("=")).Add(HX_CSTRING("+=")).Add(HX_CSTRING("-=")).Add(HX_CSTRING("*=")).Add(HX_CSTRING("/=")).Add(HX_CSTRING("%=")).Add(HX_CSTRING("<<=")).Add(HX_CSTRING(">>=")).Add(HX_CSTRING(">>>=")).Add(HX_CSTRING("|=")).Add(HX_CSTRING("&=")).Add(HX_CSTRING("^=")));		HX_STACK_VAR(priorities,"priorities");
	HX_STACK_LINE(116)
	this->opPriority = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(117)
	this->opRightAssoc = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(118)
	this->unops = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(124)
	{
		HX_STACK_LINE(124)
		int _g11 = (int)0;		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(124)
		int _g9 = priorities->length;		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(124)
		while(((_g11 < _g9))){
			HX_STACK_LINE(124)
	...
	HX_STACK_LINE(129)
	{
		...
		while(((_g9 < _g11->length))){
			HX_STACK_LINE(129)
			::String x = _g11->__get(_g9);		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(129)
			++(_g9);
			HX_STACK_LINE(130)
...
::hscript::Expr Parser_obj::parseString( ::String s){
	...
	this->line = (int)1;
	HX_STACK_LINE(147)
	return this->parse(::haxe::io::StringInput_obj::__new(s));
}
...
::hscript::Expr Parser_obj::parse( ::haxe::io::Input s){
	...
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(157)
	this->tokens = ::haxe::ds::GenericStack_hscript_Token_obj::__new();
	HX_STACK_LINE(161)
	this->_char = (int)-1;
	HX_STACK_LINE(162)
	this->input = s;
	...
	HX_STACK_LINE(165)
	{
		...
		HX_STACK_LINE(165)
		int _g = this->opChars.length;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(165)
		while(((_g1 < _g))){
			HX_STACK_LINE(165)
	...
	HX_STACK_LINE(167)
	{
		...
		int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(167)
		int _g = this->identChars.length;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(167)
		while(((_g1 < _g))){
			HX_STACK_LINE(167)
			int i = (_g1)++;		HX_STACK_VAR(i,"i");
	...
	while((true)){
		...
		HX_STACK_LINE(173)
		{
			...
			HX_STACK_LINE(173)
			_this->head = ::haxe::ds::GenericCell_hscript_Token_obj::__new(tk,_this->head);
		}
		HX_STACK_LINE(174)
...
Dynamic Parser_obj::unexpected( ::hscript::Token tk){
	...
	{
		HX_STACK_LINE(180)
		::hscript::Error err = ::hscript::Error_obj::EUnexpected(this->tokenString(tk));		HX_STACK_VAR(err,"err");
		HX_STACK_LINE(180)
		HX_STACK_DO_THROW(err);
	}
	HX_STACK_LINE(181)
...
;
		...
		HX_STACK_LINE(281)
		fl->__Field(HX_CSTRING("push"),true)(_Function_2_1::Block(this,id));
		HX_STACK_LINE(282)
		tk = this->token();
		HX_STACK_LINE(283)
...
;
	...
	struct _Function_1_1{
		inline static ::hscript::Expr Block( Dynamic &fl){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",291,0x98735743)
			{
				HX_STACK_LINE(291)
	...
	HX_STACK_LINE(291)
	return this->parseExprNext(_Function_1_1::Block(fl));
}
...
::hscript::Expr Parser_obj::parseExpr( ){
	...
	switch( (int)(tk->__Index())){
		...
		case (int)1: {
			...
			::hscript::Const c = (::hscript::Token(tk))->__Param(0);		HX_STACK_VAR(c,"c");
			struct _Function_2_1{
				inline static ::hscript::Expr Block( ::hscript::Const &c){
			...
			HX_STACK_LINE(306)
			return this->parseExprNext(_Function_2_1::Block(c));
		}
		;break;
		case (int)4: {
			HX_STACK_LINE(308)
			...
			struct _Function_2_1{
				inline static ::hscript::Expr Block( ::hscript::Expr &e){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",310,0x98735743)
					{
						HX_STACK_LINE(310)
			...
			HX_STACK_LINE(310)
			return this->parseExprNext(_Function_2_1::Block(e));
		}
		;break;
		case (int)6: {
			HX_STACK_LINE(312)
			...
			switch( (int)(tk->__Index())){
				case (int)7: {
					struct _Function_3_1{
						inline static ::hscript::Expr Block( ){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",315,0x98735743)
							{
								HX_STACK_LINE(315)
					...
					HX_STACK_LINE(315)
					return this->parseExprNext(_Function_3_1::Block());
				}
				;break;
				case (int)2: {
					HX_STACK_LINE(317)
					...
					HX_STACK_LINE(318)
					{
						...
						::haxe::ds::GenericStack_hscript_Token _this = this->tokens;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(318)
						_this->head = ::haxe::ds::GenericCell_hscript_Token_obj::__new(tk2,_this->head);
					}
					HX_STACK_LINE(319)
					{
						HX_STACK_LINE(319)
					...
					switch( (int)(tk2->__Index())){
						case (int)14: {
							HX_STACK_LINE(322)
							return this->parseExprNext(this->parseObject((int)0));
						}
						;break;
						default: {
						}
		...
		case (int)11: {
			...
			tk = this->token();
			HX_STACK_LINE(361)
			while(((tk != ::hscript::Token_obj::TBkClose))){
				HX_STACK_LINE(362)
				{
					HX_STACK_LINE(362)
					::haxe::ds::GenericStack_hscript_Token _this = this->tokens;		HX_STACK_VAR(_this,"_this");
			...
			struct _Function_2_1{
				inline static ::hscript::Expr Block( Array< ::Dynamic > &a){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",368,0x98735743)
					{
						HX_STACK_LINE(368)
			...
			HX_STACK_LINE(368)
			return this->parseExprNext(_Function_2_1::Block(a));
		}
		;break;
		default: {
			HX_STACK_LINE(370)
...
::hscript::Expr Parser_obj::makeUnop( ::String op,::hscript::Expr e){
	...
	switch( (int)(e->__Index())){
		case (int)6: {
			...
			{
				HX_STACK_LINE(376)
				::hscript::Expr e3 = ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);		HX_STACK_VAR(e3,"e3");
				HX_STACK_LINE(376)
				return e3;
			}
		}
		...
		case (int)22: {
			...
			{
				HX_STACK_LINE(377)
				::hscript::Expr e4 = ::hscript::Expr_obj::ETernary(this->makeUnop(op,e1),e2,e3);		HX_STACK_VAR(e4,"e4");
				HX_STACK_LINE(377)
				return e4;
			}
		}
	...
	switch( (int)(e->__Index())){
		case (int)6: {
			...
			HX_STACK_LINE(384)
			{
				...
				HX_STACK_LINE(385)
				if (((  (((_g <= this->opPriority->get(op2)))) ? bool(!(this->opRightAssoc->exists(op))) : bool(false) ))){
					HX_STACK_LINE(386)
					::hscript::Expr e4 = ::hscript::Expr_obj::EBinop(op2,this->makeBinop(op,e1,e2),e3);		HX_STACK_VAR(e4,"e4");
					HX_STACK_LINE(386)
					return e4;
				}
				else{
		...
		case (int)22: {
			...
			if ((this->opRightAssoc->exists(op))){
				...
				HX_STACK_LINE(393)
				::hscript::Expr e5 = ::hscript::Expr_obj::ETernary(this->makeBinop(op,e1,e2),e3,e4);		HX_STACK_VAR(e5,"e5");
				HX_STACK_LINE(393)
				return e5;
			}
		}
...
::hscript::Expr Parser_obj::parseStructure( ::String id){
	...
	if (  ( _switch_3==HX_CSTRING("if"))){
		...
		HX_STACK_LINE(414)
		if ((::Type_obj::enumEq(tk,::hscript::Token_obj::TId(HX_CSTRING("else"))))){
			HX_STACK_LINE(415)
			e2 = this->parseExpr();
		}
		else{
			...
			if ((semic)){
				...
				::haxe::ds::GenericStack_hscript_Token _this = this->tokens;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(418)
				_this->head = ::haxe::ds::GenericCell_hscript_Token_obj::__new(::hscript::Token_obj::TSemicolon,_this->head);
			}
		}
		HX_STACK_LINE(420)
		{
		...
		HX_STACK_LINE(435)
		if ((::Type_obj::enumEq(tk,::hscript::Token_obj::TOp(HX_CSTRING("="))))){
			HX_STACK_LINE(436)
			e = this->parseExpr();
		}
		else{
		...
		tk = this->token();
		HX_STACK_LINE(453)
		if ((!(::Type_obj::enumEq(tk,::hscript::Token_obj::TId(HX_CSTRING("in")))))){
			HX_STACK_LINE(453)
			this->unexpected(tk);
		}
		HX_STACK_LINE(454)
		...
		HX_STACK_LINE(460)
		return this->unexpected(::hscript::Token_obj::TId(id));
	}
		...
		{
			HX_STACK_LINE(535)
			::hscript::Expr e = ::hscript::Expr_obj::ENew(a->join(HX_CSTRING(".")),args);		HX_STACK_VAR(e,"e");
			HX_STACK_LINE(535)
			return e;
		}
	}
		...
		::hscript::Token tk = this->token();		HX_STACK_VAR(tk,"tk");
		HX_STACK_LINE(542)
		if ((!(::Type_obj::enumEq(tk,::hscript::Token_obj::TId(HX_CSTRING("catch")))))){
			HX_STACK_LINE(542)
			this->unexpected(tk);
		}
		HX_STACK_LINE(543)
		...
		if ((this->allowTypes)){
			...
			tk = this->token();
			HX_STACK_LINE(555)
			if ((!(::Type_obj::enumEq(tk,::hscript::Token_obj::TId(HX_CSTRING("Dynamic")))))){
				HX_STACK_LINE(555)
				this->unexpected(tk);
			}
		}
...
::hscript::Expr Parser_obj::parseExprNext( ::hscript::Expr e1){
	...
	switch( (int)(tk->__Index())){
			...
			HX_STACK_LINE(568)
			{
				...
				if ((this->unops->get(op))){
					...
					struct _Function_4_2{
						inline static ::hscript::Expr Block( ::hscript::Expr &e1,::String &op){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",574,0x98735743)
							{
								HX_STACK_LINE(574)
					...
					HX_STACK_LINE(574)
					return this->parseExprNext(_Function_4_2::Block(e1,op));
				}
				HX_STACK_LINE(576)
		...
		case (int)8: {
			...
			struct _Function_2_1{
				inline static ::hscript::Expr Block( ::hscript::Expr &e1,::String &field){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",584,0x98735743)
					{
						HX_STACK_LINE(584)
			...
			HX_STACK_LINE(584)
			return this->parseExprNext(_Function_2_1::Block(e1,field));
		}
		;break;
		case (int)4: {
			struct _Function_2_1{
				inline static ::hscript::Expr Block( ::hscript::Expr &e1,::hscript::Parser_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",586,0x98735743)
					{
						HX_STACK_LINE(586)
						::hscript::Expr e = ::hscript::Expr_obj::ECall(e1,__this->parseExprList(::hscript::Token_obj::TPClose));		HX_STACK_VAR(e,"e");
						HX_STACK_LINE(586)
						return e;
					}
					return null();
			...
			HX_STACK_LINE(586)
			return this->parseExprNext(_Function_2_1::Block(e1,this));
		}
		;break;
		case (int)11: {
			HX_STACK_LINE(588)
			...
			struct _Function_2_1{
				inline static ::hscript::Expr Block( ::hscript::Expr &e1,::hscript::Expr &e2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",590,0x98735743)
					{
						HX_STACK_LINE(590)
			...
			HX_STACK_LINE(590)
			return this->parseExprNext(_Function_2_1::Block(e1,e2));
		}
		;break;
		case (int)13: {
			HX_STACK_LINE(592)
...
;
					...
					default: {
						...
						::haxe::ds::GenericStack_hscript_Token _this = this->tokens;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(636)
						_this->head = ::haxe::ds::GenericCell_hscript_Token_obj::__new(t,_this->head);
					}
				}
				HX_STACK_LINE(638)
				return this->parseTypeNext(::hscript::CType_obj::CTPath(path,params));
			}
		}
		;break;
		case (int)4: {
			...
			HX_STACK_LINE(642)
			return this->parseTypeNext(::hscript::CType_obj::CTParent(t1));
		}
		;break;
		case (int)6: {
			HX_STACK_LINE(644)
				...
				if (  ( _switch_5==(int)7)){
					...
					HX_STACK_LINE(649)
					{
						...
						struct _Function_5_1{
							inline static Dynamic Block( ::hscript::Parser_obj *__this,::String &name){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Parser.hx",651,0x98735743)
								{
									hx::Anon __result = hx::Anon_obj::Create();
									__result->Add(HX_CSTRING("name") , name,false);
									__result->Add(HX_CSTRING("t") , __this->parseType(),false);
									return __result;
								}
								return null();
							}
						...
						HX_STACK_LINE(651)
						fields->__Field(HX_CSTRING("push"),true)(_Function_5_1::Block(this,name));
						HX_STACK_LINE(652)
						t = this->token();
						HX_STACK_LINE(653)
...
;
			...
			HX_STACK_LINE(662)
			return this->parseTypeNext(::hscript::CType_obj::CTAnon(fields));
		}
		;break;
		default: {
			HX_STACK_LINE(664)
...
::hscript::Token Parser_obj::token( ){
	...
	while((true)){
		...
		switch( (int)(_char)){
				...
				while((true)){
					...
					switch( (int)(_char)){
						...
						case (int)46: {
							...
							if (((exp > (int)0))){
								HX_STACK_LINE(849)
								if (((  (((exp == (int)10))) ? bool((this->readChar() == (int)46)) : bool(false) ))){
									HX_STACK_LINE(850)
									{
										HX_STACK_LINE(850)
									...
									HX_STACK_LINE(852)
									return ::hscript::Token_obj::TConst((  (((i == n))) ? ::hscript::Const(::hscript::Const_obj::CInt(i)) : ::hscript::Const(::hscript::Const_obj::CFloat(n)) ));
								}
								HX_STACK_LINE(854)
								this->invalidChar(_char);
							}
							...
							while((true)){
								...
								switch( (int)(_char)){
									...
									default: {
										...
										this->_char = _char;
										HX_STACK_LINE(874)
										return ::hscript::Token_obj::TConst(::hscript::Const_obj::CInt(n1));
									}
								}
							}
						}
						...
						default: {
							...
							int i = ::Std_obj::_int(n);		HX_STACK_VAR(i,"i");
							HX_STACK_LINE(901)
							return ::hscript::Token_obj::TConst((  (((exp > (int)0))) ? ::hscript::Const(::hscript::Const_obj::CFloat((Float((n * (int)10)) / Float(exp)))) : ::hscript::Const((  (((i == n))) ? ::hscript::Const(::hscript::Const_obj::CInt(i)) : ::hscript::Const(::hscript::Const_obj::CFloat(n)) )) ));
						}
					}
				}
			}
						...
						while((true)){
							...
							switch( (int)(_char)){
								...
								default: {
									...
									this->_char = _char;
									HX_STACK_LINE(922)
									return ::hscript::Token_obj::TConst(::hscript::Const_obj::CFloat((Float(n) / Float(exp))));
								}
							}
						}
					}
			...
			case (int)39: {
				HX_STACK_LINE(938)
				return ::hscript::Token_obj::TConst(::hscript::Const_obj::CString(this->readString((int)39)));
			}
			;break;
			case (int)34: {
				HX_STACK_LINE(939)
				return ::hscript::Token_obj::TConst(::hscript::Const_obj::CString(this->readString((int)34)));
			}
			;break;
			case (int)63: {
				HX_STACK_LINE(940)
			...
			default: {
				...
				if ((this->ops->__get(_char))){
					...
					while((true)){
						...
						HX_STACK_LINE(953)
						hx::AddEq(op,::String::fromCharCode(_char));
					}
				}
				HX_STACK_LINE(956)
				if ((this->idents->__get(_char))){
					...
					while((true)){
						...
						HX_STACK_LINE(964)
						hx::AddEq(id,::String::fromCharCode(_char));
					}
				}
				HX_STACK_LINE(967)
				this->invalidChar(_char);
...
::hscript::Token Parser_obj::tokenComment( ::String op,int _char){
	...
	if (((c == (int)47))){
		...
		{
			HX_STACK_LINE(979)
			while(((bool((_char != (int)10)) && bool((_char != (int)13))))){
				HX_STACK_LINE(981)
				_char = s->readByte();
			}
			HX_STACK_LINE(983)
