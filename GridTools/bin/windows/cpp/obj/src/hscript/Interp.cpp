...
{
	HX_STACK_LINE(50)
	this->locals = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(51)
	this->variables = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(56)
	...
	Void run(Dynamic e){
		...
		HX_STACK_ARG(e,"e")
		{
			...
			HX_STACK_LINE(60)
			::haxe::Log_obj::trace(_g,_Function_2_1::Block());
		}
		return null();
	}
...
Void Interp_obj::initOps( ){
{
		...
		HX_STACK_LINE(67)
		this->binops = ::haxe::ds::StringMap_obj::__new();
		...
		Dynamic run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(71)
				Dynamic _g = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(71)
				return (_g + me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		...
		Float run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(72)
				Dynamic _g1 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(72)
				return (_g1 - me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		Float run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(73)
				Dynamic _g2 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(73)
				return (_g2 * me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		Float run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(74)
				Dynamic _g3 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(74)
				return (Float(_g3) / Float(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		Float run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(75)
				Dynamic _g4 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g4,"_g4");
				HX_STACK_LINE(75)
				return hx::Mod(_g4,me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(76)
				Dynamic _g5 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g5,"_g5");
				HX_STACK_LINE(76)
				return (int(_g5) & int(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(77)
				Dynamic _g6 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(77)
				return (int(_g6) | int(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(78)
				Dynamic _g7 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(78)
				return (int(_g7) ^ int(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(79)
				Dynamic _g8 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g8,"_g8");
				HX_STACK_LINE(79)
				return (int(_g8) << int(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(80)
				Dynamic _g9 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g9,"_g9");
				HX_STACK_LINE(80)
				return (int(_g9) >> int(me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2)));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		int run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(81)
				Dynamic _g10 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g10,"_g10");
				HX_STACK_LINE(81)
				return hx::UShr(_g10,me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(82)
				Dynamic _g11 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(82)
				return (_g11 == me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(83)
				Dynamic _g12 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g12,"_g12");
				HX_STACK_LINE(83)
				return (_g12 != me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(84)
				Dynamic _g13 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g13,"_g13");
				HX_STACK_LINE(84)
				return (_g13 >= me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(85)
				Dynamic _g14 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g14,"_g14");
				HX_STACK_LINE(85)
				return (_g14 <= me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(86)
				Dynamic _g15 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g15,"_g15");
				HX_STACK_LINE(86)
				return (_g15 > me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(87)
				Dynamic _g16 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g16,"_g16");
				HX_STACK_LINE(87)
				return (_g16 < me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
		...
		bool run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(88)
				if ((!(((me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1) == true))))){
					HX_STACK_LINE(88)
					return (me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2) == true);
				}
				else{
					HX_STACK_LINE(88)
					return true;
		...
		::IntIterator run(::hscript::Expr e1,::hscript::Expr e2){
			...
			{
				HX_STACK_LINE(91)
				Dynamic _g17 = me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e1);		HX_STACK_VAR(_g17,"_g17");
				HX_STACK_LINE(91)
				return ::IntIterator_obj::__new(_g17,me->__get((int)0).StaticCast< ::hscript::Interp >()->expr(e2));
			}
			return null();
		}
		HX_END_LOCAL_FUNC2(return)
...
Dynamic Interp_obj::assign( ::hscript::Expr e1,::hscript::Expr e2){
	...
	switch( (int)(e1->__Index())){
		...
		case (int)16: {
			...
			{
				HX_STACK_LINE(117)
				Dynamic _g = this->expr(index);		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(117)
				hx::IndexRef((this->expr(e)).mPtr,_g) = v;
			}
		}
		;break;
		default: {
	...
	switch( (int)(e1->__Index())){
		...
		case (int)5: {
			...
			HX_STACK_LINE(138)
			{
				...
				HX_STACK_LINE(140)
				Dynamic _g1 = this->get(obj,f);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(140)
				v = fop(_g1,this->expr(e2));
				HX_STACK_LINE(141)
				v = this->set(obj,f,v);
			}
		}
		...
		case (int)16: {
			...
			HX_STACK_LINE(142)
			{
				...
				HX_STACK_LINE(145)
				v = fop(arr->__GetItem(index1),this->expr(e2));
				HX_STACK_LINE(146)
...
Void Interp_obj::restore( int old){
{
		...
		HX_STACK_LINE(222)
		while(((this->declared->__Field(HX_CSTRING("length"),true) > old))){
			HX_STACK_LINE(223)
		...
		case (int)2: {
			...
			HX_STACK_LINE(251)
			{
				struct _Function_3_1{
					inline static Dynamic Block( ::hscript::Interp_obj *__this,::String &n){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Interp.hx",252,0xf078416e)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("n") , n,false);
							__result->Add(HX_CSTRING("old") , __this->locals->get(n),false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(252)
				this->declared->__Field(HX_CSTRING("push"),true)(_Function_3_1::Block(this,n));
				HX_STACK_LINE(253)
				{
					struct _Function_4_1{
						inline static Dynamic Block( ::hscript::Expr &e1,::hscript::Interp_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Interp.hx",253,0xf078416e)
							{
								hx::Anon __result = hx::Anon_obj::Create();
								__result->Add(HX_CSTRING("r") , (  (((e1 == null()))) ? Dynamic(null()) : Dynamic(__this->expr(e1)) ),false);
								return __result;
							}
							return null();
						}
					...
					HX_STACK_LINE(253)
					Dynamic value = _Function_4_1::Block(e1,this);		HX_STACK_VAR(value,"value");
					HX_STACK_LINE(253)
...
;
			...
			HX_STACK_LINE(289)
			{
				...
				HX_STACK_LINE(291)
				{
					...
					while(((_g < params->length))){
						...
						++(_g);
						HX_STACK_LINE(292)
						args->__Field(HX_CSTRING("push"),true)(this->expr(p));
					}
				}
				HX_STACK_LINE(293)
				switch( (int)(e1->__Index())){
		...
		case (int)15: {
			...
			::hscript::Expr e1 = (::hscript::Expr(e))->__Param(0);		HX_STACK_VAR(e1,"e1");
			HX_STACK_LINE(314)
			HX_STACK_DO_THROW(::hscript::_Interp::Stop_obj::SReturn((  (((e1 == null()))) ? Dynamic(null()) : Dynamic(this->expr(e1)) )));
		}
		;break;
		case (int)14: {
			HX_STACK_LINE(239)
			...
			HX_STACK_LINE(315)
			{
				...
				Dynamic run(Dynamic args){
					...
					HX_STACK_ARG(args,"args")
					{
						...
						HX_STACK_LINE(321)
						me->__get((int)0).StaticCast< ::hscript::Interp >()->locals = me->__get((int)0).StaticCast< ::hscript::Interp >()->duplicate(capturedLocals->__get((int)0).StaticCast< ::haxe::ds::StringMap >());
						HX_STACK_LINE(322)
						{
							HX_STACK_LINE(322)
						...
						{
							HX_STACK_LINE(326)
							r = me->__get((int)0).StaticCast< ::hscript::Interp >()->exprReturn(fexpr->__get((int)0).StaticCast< ::hscript::Expr >());
						}
						}
						catch(Dynamic __e){
							{
			...
			HX_STACK_LINE(342)
			{
				...
				HX_STACK_LINE(344)
				{
					...
					while(((_g < arr->length))){
						...
						++(_g);
						HX_STACK_LINE(345)
						a->__Field(HX_CSTRING("push"),true)(this->expr(e1));
					}
				}
				HX_STACK_LINE(346)
				return a;
		...
		case (int)16: {
			...
			HX_STACK_LINE(347)
			{
				...
				Dynamic _g = this->expr(e1);		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(348)
				return _g->__GetItem(this->expr(index));
			}
		}
		;break;
		case (int)18: {
				...
				HX_STACK_CATCHABLE(Dynamic, 1);
				{
					...
					if (__e.IsClass< ::hscript::_Interp::Stop >() ){
						...
						Dynamic err = __e;{
							...
							HX_STACK_LINE(368)
							this->declared->__Field(HX_CSTRING("push"),true)(_Function_4_1::Block(this,n));
		...
		case (int)21: {
			...
			HX_STACK_LINE(374)
			{
				...
				HX_STACK_LINE(376)
				{
					...
					int _g = (int)0;		HX_STACK_VAR(_g,"_g");
					HX_STACK_LINE(376)
					while(((_g < fl->__Field(HX_CSTRING("length"),true)))){
						HX_STACK_LINE(376)
						Dynamic f = fl->__GetItem(_g);		HX_STACK_VAR(f,"f");
						HX_STACK_LINE(376)
						++(_g);
						HX_STACK_LINE(377)
						this->set(o,f->__Field(HX_CSTRING("name"),true),this->expr(f->__Field(HX_CSTRING("e"),true)));
					}
				}
				HX_STACK_LINE(378)
				return o;
...
Dynamic Interp_obj::makeIterator( Dynamic v){
	...
	{
		HX_STACK_LINE(405)
		v = v->__Field(HX_CSTRING("iterator"),true)();
	}
	}
	catch(Dynamic __e){
		{
...
Void Interp_obj::forLoop( ::String n,::hscript::Expr it,::hscript::Expr e){
{
		...
		HX_STACK_LINE(413)
		this->declared->__Field(HX_CSTRING("push"),true)(_Function_1_1::Block(this,n));
		HX_STACK_LINE(414)
		Dynamic it1 = this->makeIterator(this->expr(it));		HX_STACK_VAR(it1,"it1");
		HX_STACK_LINE(415)
		while((it1->__Field(HX_CSTRING("hasNext"),true)())){
			HX_STACK_LINE(416)
			{
				struct _Function_3_1{
					inline static Dynamic Block( Dynamic &it1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","hscript/Interp.hx",416,0xf078416e)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("r") , it1->__Field(HX_CSTRING("next"),true)(),false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(416)
				Dynamic value = _Function_3_1::Block(it1);		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(416)
				this->locals->set(n,value);
			}
			HX_STACK_LINE(417)
...
Dynamic Interp_obj::fcall( Dynamic o,::String f,Dynamic args){
	HX_STACK_FRAME("hscript.Interp","fcall",0x6ff6aee5,"hscript.Interp.fcall","hscript/Interp.hx",442,0xf078416e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(f,"f")
	HX_STACK_ARG(args,"args")
	HX_STACK_LINE(442)
	return this->call(o,::Reflect_obj::field(o,f),args);
}
