...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","hasField",0xef8c2571,"Reflect.hasField","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",25,0xe6f865ea)
	HX_STACK_ARG(o,"o")
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","field",0x54b04da9,"Reflect.field","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",29,0xe6f865ea)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(29)
	if (((o == null()))){
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_FRAME("Reflect","callMethod",0xb49e52d0,"Reflect.callMethod","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",46,0xe6f865ea)
	HX_STACK_ARG(o,"o")
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_FRAME("Reflect","fields",0xc593a6aa,"Reflect.fields","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",53,0xe6f865ea)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(54)
	if (((o == null()))){
		HX_STACK_LINE(54)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_FRAME("Reflect","isFunction",0x0f1541d3,"Reflect.isFunction","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",61,0xe6f865ea)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(61)
	if (((f != null()))){
		HX_STACK_LINE(61)
...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Reflect","compare",0xa2d92b54,"Reflect.compare","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",65,0xe6f865ea)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(65)
	if (((a == b))){
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_FRAME("Reflect","compareMethods",0x8b8ddd7e,"Reflect.compareMethods","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",68,0xe6f865ea)
	HX_STACK_ARG(f1,"f1")
	HX_STACK_ARG(f2,"f2")
	HX_STACK_LINE(69)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_FRAME("Reflect","isObject",0xd04960ba,"Reflect.isObject","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",76,0xe6f865ea)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(77)
	if (((v == null()))){
		HX_STACK_LINE(77)
...
bool Reflect_obj::deleteField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","deleteField",0x21895ebe,"Reflect.deleteField","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",87,0xe6f865ea)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(88)
	if (((o == null()))){
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	HX_STACK_FRAME("Reflect","makeVarArgs",0x978955c5,"Reflect.makeVarArgs","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",105,0xe6f865ea)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(105)
