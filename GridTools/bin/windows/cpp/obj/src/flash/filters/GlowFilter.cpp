...
{
HX_STACK_FRAME("flash.filters.GlowFilter","new",0xcc934608,"flash.filters.GlowFilter.new","flash/filters/GlowFilter.hx",21,0xa094f026)
...
::flash::filters::BitmapFilter GlowFilter_obj::clone( ){
	HX_STACK_FRAME("flash.filters.GlowFilter","clone",0x3ba94305,"flash.filters.GlowFilter.clone","flash/filters/GlowFilter.hx",42,0xa094f026)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
	return ::flash::filters::GlowFilter_obj::__new(this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout);
}
