...
{
HX_STACK_FRAME("flash.filters.DropShadowFilter","new",0x8395d22a,"flash.filters.DropShadowFilter.new","flash/filters/DropShadowFilter.hx",20,0xde28a0c4)
...
::flash::filters::BitmapFilter DropShadowFilter_obj::clone( ){
	HX_STACK_FRAME("flash.filters.DropShadowFilter","clone",0xa1809ba7,"flash.filters.DropShadowFilter.clone","flash/filters/DropShadowFilter.hx",41,0xde28a0c4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(41)
