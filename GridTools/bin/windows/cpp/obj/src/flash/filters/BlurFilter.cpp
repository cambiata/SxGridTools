...
{
HX_STACK_FRAME("flash.filters.BlurFilter","new",0x05551ea2,"flash.filters.BlurFilter.new","flash/filters/BlurFilter.hx",12,0x8794a8cc)
...
::flash::filters::BitmapFilter BlurFilter_obj::clone( ){
	HX_STACK_FRAME("flash.filters.BlurFilter","clone",0x8b05f61f,"flash.filters.BlurFilter.clone","flash/filters/BlurFilter.hx",25,0x8794a8cc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
