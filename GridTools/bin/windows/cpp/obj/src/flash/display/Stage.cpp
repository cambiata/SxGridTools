...
int Stage_obj::get_stageHeight( ){
	HX_STACK_FRAME("flash.display.Stage","get_stageHeight",0xe188cca2,"flash.display.Stage.get_stageHeight","flash/display/Stage.hx",1302,0x8d64160c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1302)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_FRAME("flash.display.Stage","get_stageWidth",0xac6421ab,"flash.display.Stage.get_stageWidth","flash/display/Stage.hx",1309,0x8d64160c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1309)
