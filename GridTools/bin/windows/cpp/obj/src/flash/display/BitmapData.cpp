...
bool smoothing = __o_smoothing.Default(false);
	HX_STACK_FRAME("flash.display.BitmapData","draw",0xceed8bcf,"flash.display.BitmapData.draw","flash/display/BitmapData.hx",151,0x1e513fd9)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flash.display.BitmapData","__loadFromBytes",0x2355ea90,"flash.display.BitmapData.__loadFromBytes","flash/display/BitmapData.hx",637,0x1e513fd9)
		HX_STACK_THIS(this)
...
::flash::geom::Rectangle BitmapData_obj::get_rect( ){
	...
	int _g = this->get_width();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(705)
	return ::flash::geom::Rectangle_obj::__new((int)0,(int)0,_g,this->get_height());
}
...
::flash::utils::ByteArray BitmapData_obj::getRGBAPixels( ::flash::display::BitmapData bitmapData){
	...
	HX_STACK_LINE(248)
	::flash::utils::ByteArray data = bitmapData->getPixels(::flash::geom::Rectangle_obj::__new((int)0,(int)0,_g,bitmapData->get_height()));		HX_STACK_VAR(data,"data");
	HX_STACK_LINE(249)
...
::flash::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes bytes,::haxe::io::Bytes rawAlpha){
	...
	HX_STACK_LINE(313)
	return ::flash::display::BitmapData_obj::loadFromBytes(_g,(  (((rawAlpha == null()))) ? ::flash::utils::ByteArray(null()) : ::flash::utils::ByteArray(::flash::utils::ByteArray_obj::fromBytes(rawAlpha)) ));
}
